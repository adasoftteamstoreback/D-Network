            ...
            <table class="table table-striped" style="width:100%" id="otbTableForCheckbox">
                <thead>
					<tr class="xCNCenter">
                        ...
                        <th class="xCNTextBold" style="width:160px;"><?= language('settingconfig/settingconfig/settingconfig','tTableValueNormal')?></th>
                        <th class="xCNTextBold" style="width:160px;"><?= language('settingconfig/settingconfig/settingconfig','tTableValueMake')?></th>
                    </tr>
                </thead>
                <tbody>
...
<div class="row">
    <div class="col-md-12">
        <!-- <div class="table-responsive xCNTableScrollY xCNTableHeightInput"> -->
        <div class="table-responsive">
            <table class="table table-striped" style="width:100%" id="otbTableForInput">
                <thead>
					<tr class="xCNCenter">
                        ...
                        <th class="xCNTextBold" style="width:160px;"><?= language('settingconfig/settingconfig/settingconfig','tTableValueMake')?></th>
                        <!-- <th class="xCNTextBold" style="width:160px;"><?= language('settingconfig/settingconfig/settingconfig','tTableRef')?></th> -->
                    </tr>
                </thead>
                <tbody>
                    <?php if($aResListInputText['rtCode'] == 1 ):?>
                        <?php foreach($aResListInputText['raItems'] AS $key=>$aValue){ ?>
                            <tr class="text-center xCNTextDetail2" style="cursor: pointer;" onclick="JSxAppendSpanDetail(this,'input')">
                                ...
                                <?php 
                                    ...
                                    switch ($aValue['FTSysStaDataType']) {
                                        ...
                                        case "5": //COMBO
                                            ...
                                            break;
                                        case "6": //BROWSE
                                                if($aValue['FTSysCode'] == 'tPS_RcvCash'){ //ประเภทการชำระเงิน
                                                    $tContentMake   =   "<div class='input-group'>
                                                                            <input type='text' 
                                                                            data-SysCode    = '".$aValue['FTSysCode']."'
                                                                            data-SysApp     = '".$aValue['FTSysApp']."'
                                                                            ...
                                                                            <span class='input-group-btn'>
                                                                                <button type='button' class='btn xCNBtnBrowseAddOn' onclick=JSxClickMakeBrowseMuti('".$tID."','oBrowseMakeType')>
                                                                                    <img src='".base_url()."/application/modules/common/assets/images/icons/find-24.png'>
                                                                                </button>
                                                                            </span>
                                                                        </div>";
                                                    $tContentRef    =   "";
                                                }else if($aValue['FTSysCode'] == 'tCN_FCSupplier'){ //ผู้จำหน่าย
                                                    $tContentMake   =   "<div class='input-group'>
                                                                            <input type='text' 
                                                                            data-SysCode    = '".$aValue['FTSysCode']."'
                                                                            data-SysApp     = '".$aValue['FTSysApp']."'
                                                                            ...
                                                                            value='".$aValue['FTSysStaUsrValue']."' readonly>
                                                                            <span class='input-group-btn'>
                                                                                <button type='button' class='btn xCNBtnBrowseAddOn' onclick=JSxClickMakeBrowseSPL('".$tID."','oBrowseMakeSPL')>
                                                                                    <img src='".base_url()."/application/modules/common/assets/images/icons/find-24.png'>
                                                                                </button>
                                                                            </span>
                                                                        </div>";
                                ...
                                <!-- <td style="text-align:left;"><?php //$tContentRef?></td> -->
                            </tr>
                        <?php } ?>
                    <?php else:?>
                    <tr><td class='text-center xCNTextDetail2' colspan='8'><?= language('common/main/main','tCMNNotFoundData')?></td></tr>
...
<script>
    ...
    var oBrowseMakeSPL = {
        ...
        CallBack    :   {
            ReturnType	: 'S',
            Value		: ["oetMakeBrowseID","TCNMSpl.FTSplCode"],
            Text		: ["oetMakeBrowseName","TCNMSpl_L.FTSplCode"],
        }
    } 
    function JSxClickMakeBrowseSPL(elemID,ptBrowseName){
        oBrowseMakeSPL.CallBack.Value[0]    = 'oetMakeBrowseID' + elemID;
        oBrowseMakeSPL.CallBack.Text[0]     = 'oetMakeBrowseName' + elemID;
    ...
    //Browse ประเภทการชำระเงิน(กำหนดเอง)
    var nLangEdits = <?=$this->session->userdata("tLangEdit")?>;
    var oBrowseMakeType = {
        ...
        Where: {
            Condition: [" AND TFNMRcv.FTRcvStaUse = 1 AND TFNMRcv.FTFmtCode = '001' "]
        },
        GrideView   :   {
        ...
        CallBack:{
            Value		: ['oetMakeBrowseID','TFNMRcv.FTRcvCode'],
            Text		: ['oetMakeBrowseName','TFNMRcv_L.FTRcvCode']
        }
    }
    function JSxClickMakeBrowseMuti(elemID,ptBrowseName){
        oBrowseMakeType.CallBack.Value[0]    = 'oetMakeBrowseID' + elemID;
        oBrowseMakeType.CallBack.Text[0]     = 'oetMakeBrowseName' + elemID;
        JCNxBrowseMultiSelect(ptBrowseName);
    }
