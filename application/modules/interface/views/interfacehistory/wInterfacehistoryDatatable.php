                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    if($aValue['FTLogType'] == '2'){
                                        $tPathFile = $tPathFile_Out.$aValue['FTLogTaskRef']; //ส่งออก
                                    }else{
                                        $tPathFile = $tPathFile_In.$aValue['FTLogTaskRef']; //นำเข้า
                                    }
                                    ?>
                                    ...
                                    <a href="<?= $tPathFile; ?>">
                                        <?php if($aValue['FTLogTaskRef'] == '' || $aValue['FTLogTaskRef'] == null || $aValue['FTLogType'] == '2'){ ?>
