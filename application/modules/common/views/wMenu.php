<?php
    ...
    $tCNStaExpire       = "1";
?>
<?php //print_r($oGrpModules[8]); ?>
<!-- MENU BUTTON -->

<!--ถ้ามาจาก font จะไม่ต้องแสดง bar -->
<?php if($this->session->userdata("tStaByPass") != 1){ ?>
    <div id="odvMenuLeft" style="width:60px;height: 100%;float: left;background-color: #2c82b6;position: fixed;z-index: 6000;margin-top: -56px;">
        ...
        <div class="container-fluid xWContainer-fluid">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="form-group">
                    <input class="form-control xWinputSearchmenu" type="text" id="oetMenSearch" name="oetMenSearch" placeholder="<?=language('common/main/main','tPlaceholder')?>" style="margin:0px;">
                </div>
            </div>
        </div>
        <div class="sidebar-scroll">
            ...
            <nav id="oNavMenuAdasoft" class="xCNMargintop10 xCNMenuList">
                ...
                <li class="treeview-item xCNMenuItem">
                    ...
                    <!-- <li class="treeview-item xCNMenuItem">
                        <a data-mnrname="shop/0/0/LOCKER" data-toggle="collapse" class="collapsed xWLiSubmenu">
                            <span style="margin-left:-27px;"><?=language('register/register','Locker');?></span>
                        </a>
                    </li>
                    <li class="treeview-item xCNMenuItem">
                        <a data-mnrname="dcmSOData/0/0" data-toggle="collapse" class="collapsed xWLiSubmenu">
                            <span style="margin-left:-27px;"><?=language('register/register','ตรวจสอบข้อมูลใบสั่งขาย');?></span>
                        </a>
                    </li> -->
