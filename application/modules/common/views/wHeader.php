...
<html lang="th" class="fullscreen-bg">
    <head>
        ...
        <!--FullCalendar-->
        <link rel="stylesheet" href="<?php echo base_url(); ?>application/modules/common/assets/css/fullcalendar.css">
        ...
        <script src="<?php echo base_url(); ?>application/modules/common/assets/js/fullcalendar.js"></script>
        <script src="<?php echo base_url(); ?>application/modules/common/assets/js/tinymce.min.js"></script>
        <style type="text/css">
            .ldBar-label {
                color: #21bd35;
                font-family: tahoma;
