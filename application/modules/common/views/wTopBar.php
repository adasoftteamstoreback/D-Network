...
<div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div id="navbar-menu">
                    ...
                    <ul class="nav navbar-nav navbar-right <?php if(!$this->session->userdata("bSesAlwNoti")){ echo "xCNHide"; } ?>" >
                        <li class="dropdown">
                            <a href="#" onclick="return false;" role="button" data-toggle="dropdown" id="notification" style="float: left" aria-expanded="true">
                    ...
                    <ul class="nav navbar-nav navbar-right <?php if(!$this->session->userdata("bSesAlwNews")){ echo "xCNHide"; } ?>">
                        <li class="dropdown">
                            <a href="#" onclick="return false;" role="button" data-toggle="dropdown" id="notification" style="float: left" aria-expanded="true">
                                <i class="fa fa-envelope-o" style="font-size: 20px; float: left; color: black"></i>
                            </a>
 ...
 <script>
    ...
    $(document).ready(function(){
        ...
        //ถ้ามาจาก font จะไม่ต้องแสดง bar
        if('<?=$this->session->userdata("tStaByPass")?>' != 1){
			JSxGetNameCompany();
