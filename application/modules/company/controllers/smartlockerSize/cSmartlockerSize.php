...
class cSmartlockerSize extends MX_Controller {
    ...
    public function index(){
        ...
        $this->load->view('company/smartlockerSize/wSmartlockerSize',array(
    ...
    public function FSvCMSDataList(){
        ...
        //สิทธิ
        $aAlwEventSMS   = FCNaHCheckAlwFunc('SHPSmartLockerSize');
        $aData  = array(
    ...
    public function FSvCSMSPageAdd(){
        ...
        $nPageShpCallBack                = $this->input->post('nPageShpCallBack');
        $vBtnSaveSmartlockerSize         = FCNaHBtnSaveActiveHTML('SHPSmartLockerSize');
        $aAlwEventSmartlockerSize        = FCNaHCheckAlwFunc('SHPSmartLockerSize');
