...
class cRack extends MX_Controller {
	...
	//Return : String View
	//Return Type : View
    public function FSvCSMSmartlockerRackIndex(){
        $nPageShpCallBack       = $this->input->post('nPageShpCallBack');
        $vBtnSaveRack          = FCNaHBtnSaveActiveHTML('rack/0/0');
        $aAlwEventRack   = FCNaHCheckAlwFunc('rack/0/0');
        $vBtnSave       = FCNaHBtnSaveActiveHTML('SHPSmartLockerrack');
        $this->load->view('company/rack/tabrack/wSmartlockerRack',array(
