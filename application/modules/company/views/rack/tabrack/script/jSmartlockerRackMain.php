                ...
                $.ajax({
                    ...
                    success: function(tResult) {
                        ...
                        if (aReturnData["nStaEvent"] == 1) {
                                ...
                                case "1":
                                    JSvCallPageRackEdit(aReturnData["tCodeReturn"]);
                                    break;
                                case "2":
                                    SHPSmartLockerrackPageAdd();
                                    break;
                                case "3":
                                    JSvRackMain();
                                    break;
...
function JSvCallPageRackEdit(ptRckCode) {
    ...
    if (typeof(nStaSession) !== 'undefined' && nStaSession == 1) {
        ...
        $.ajax({
            ...
            success: function(tResult) {
                if (tResult != "") {
                    $('#odvContentRackSizeMain').html(tResult);
    ...
    function JSxRackNavDefult() {
     ...
     //Call list
    function JSvRackMain(nPage){
        JCNxOpenLoading();
        $.ajax({
            type    : "POST",
            url     : "SHPSmartLockerrackMain",
            cache   : false,
            Timeout : 0,
            async   : false,
            success : function(tView){
                ...
                $('#odvContentRackSizeMain').html(tView);
                JSvRackList(1);
                JSxRackNavDefult();
            },
