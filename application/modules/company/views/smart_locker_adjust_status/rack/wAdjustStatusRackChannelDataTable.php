...
<style>
    ...
    .xWRackChannelItems.xCNActive {
        background-color: #1866ae !important;
    }
</style>
<div class="row">
    <div class="col-md-12">
        <div class="table-responsive">
            <table class="table table-striped">
                <thead>
                    <tr class="xCNCenter">
                        <th class="xCNTextBold" width="25%"><?=language('company/smart_locker_adjust_status/smartlockeradjsta', 'tSMLKAdjStaChannelNo')?></th>
                        <th class="xCNTextBold" width="25%"><?=language('company/smart_locker_adjust_status/smartlockeradjsta', 'tSMLKAdjStaChannelName')?></th>
                ...
                <?php if($aDataList['rtCode'] == 1 ) { ?>
                    <?php foreach($aDataList['raItems'] AS $key => $aItem) { ?>
                        <tr 
                            ...
                            if($aItem['FTLayStaUse'] == '4'){$tLayStaUse = language('company/smart_locker_adjust_status/smartlockeradjsta', 'จอง');}
                            ?>
