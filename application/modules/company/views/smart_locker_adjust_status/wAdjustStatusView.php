...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        ...
        <ol id="oliMenuNav" class="breadcrumb">
            ...
            <li id="oliSMLKAdjStaAdd" class="active" style="display: inline-block;"><a style="font-size: 18px !important;">/ &nbsp;&nbsp;&nbsp;<?=language('company/smart_locker_adjust_status/smartlockeradjsta', 'tSMLKAdjStaHis')?></a></li>
        </ol>
        <!-- Breadcrumb -->
    </div>
</div>
