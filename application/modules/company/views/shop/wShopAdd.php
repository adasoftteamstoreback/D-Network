		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="custom-tabs-line tabs-line-bottom left-aligned">
				<ul class="nav" role="tablist">
					...
					-->
					<!--ข้อมูลทั่วไป-->
					<li id="oliSHPDetail" class="xCNSHPTab active" data-typetab="main" data-tabtitle="shpinfo" style="cursor: pointer">
					...
					<!-- คลังสินค้า -->
					<li id="oliSHPWah" class="xCNSHPTab<?php echo @$tMenuTabDisable;?>" data-typetab="sub" data-tabtitle="shpwah" onclick="JSxShpWahGetContent();" style="cursor: pointer">
					...
					<?php if( $tShpType == 4 || $tShpType == 6 ){ ?>
						<!-- ชั้นตู้ cabinet-->
						<li id="oliSHPVedingCabinet" class="xCNSHPTab<?php echo $tMenuTabDisableV;?>" data-typetab="sub" data-tabtitle="shpvdcabinet" style="cursor: pointer">
						...
						<!--รูปแบบตู้ vending-->
						<li id="oliSHPVedingShoplayout" class="xCNSHPTab<?php echo $tMenuTabDisableV;?>" data-typetab="sub" data-tabtitle="shpvdlayout" style="cursor: pointer">
						...
						<!--เครื่องจุดขาย-->
						<li id="oliSHPPOSShop" class="xCNSHPTab<?php echo $tMenuTabDisable;?>" data-typetab="sub" data-tabtitle="shpposshop" style="cursor: pointer">
					...
					<?php }else if($tShpType == 5){ ?>
						<!--ขนาด smart locker-->
						<!--<li id="oliSmartLockerSize" class="xCNSHPTab" data-typetab="sub" data-tabtitle="shplksize" style="cursor: pointer">
						...
						<!--<li id="oliSmartLockerRack" class="xCNSHPTab" data-typetab="sub" data-tabtitle="shpRack" style="cursor: pointer">
						...
						<li id="oliSmartLockerType" class="xCNSHPTab" data-typetab="sub" data-tabtitle="shplktype" style="cursor: pointer">
						...
						<li id="oliSmartLockerLayout" class="xCNSHPTab" data-typetab="sub" data-tabtitle="shplklayout" style="cursor: pointer">
					...
					<?php } ?>
					<!-- ที่อยู่ร้านค้า -->
					<li id="oliSHPAddress" class="xCNSHPTab<?php echo @$tMenuTabDisable;?>" data-typetab="sub" data-tabtitle="shpaddress" style="cursor: pointer">
