		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="custom-tabs-line tabs-line-bottom left-aligned">
				<ul class="nav" role="tablist">
					<li id="oliBchTabInfoNav" class="xCNBCHTab active" data-typetab="main" data-tabtitle="bchinfo" style="cursor: pointer;">
					...
					<li id="oliBchTabInfoNav" class="xCNBCHTab<?php echo $tMenuTabDisable;?>" data-typetab="sub" data-tabtitle="bchaddress" style="cursor: pointer;"> 
					...
					<!-- <li id="oliBchTabInfoNav" class="xCNBCHTab<?php echo $tMenuTabDisable;?>" data-typetab="sub" data-tabtitle="wahouse" style="cursor: pointer;">
						<a role="tab" data-toggle="<?php echo $tMenuTabToggle;?>" data-target="#odvBranchSetWah" aria-expanded="true">
							<?php echo language('common/main/main','tCenterModalPDTWah')?>
						</a>
					</li>
			...
			<div id="odvBchContentDataTab" class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-xs-12">
					<div class="tab-content">
										...
										<div class="row">
											...
											<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
													...
													<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
														<div class="form-group">
															...
															<div class="input-group xWBchDisplayAgency">
																<input type="text" class="form-control xCNHide" id="oetBchTypeSEL" name="oetBchTypeSEL" >
																...
																<span class="input-group-btn">
																	<button id="obtBchBrowseAgency" type="button" class="btn xCNBtnBrowseAddOn" <?=$tDisabled;?>><img class="xCNIconFind"></button>
																</span>
															</div>
														</div>
													</div>
												...
												<div class="row">
													...
													<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
														<div class="form-group">
															<label class="xCNLabelFrm"><span class="text-danger">*</span> <?php echo  language('company/branch/branch','tBCHBchNewRefID')?></label>
															<input
																class="form-control"
																type="text" id="oetBchRefID"
																name="oetBchRefID"
																maxlength="30"
																placeholder="<?php echo language('company/branch/branch','tBCHBchNewRefID')?>"
																data-validate-required ="<?php echo language('company/branch/branch','tBCHBchNewRefID')?>"
													...
													<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
														<div class="form-group">
															<label class="fancy-checkbox">
																...
																<?php if($nCheckHQSta > 0 && $tBchStaHQ != 1){
																	echo "disabled";
																} ?>
																>
						...
						<!-- Tab Info คลังสินค้า -->
						<div id="odvBranchSetWah" class="tab-pane fade">
						</div>
