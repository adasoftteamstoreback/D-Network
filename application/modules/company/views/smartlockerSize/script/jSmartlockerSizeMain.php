                ...
                $.ajax({
                    ...
                    success: function(tResult) {
                            ...
                            if (aReturnData["nStaEvent"] == 1) {
                                ...
                                case "1":
                                    JSvCallPageSmartlockerSizeEdit(aReturnData["tCodeReturn"]);
                                    break;
                                case "2":
                                    JSvCallPageSmartlockerSizeAdd();
                                    break;
                                case "3":
                                    JSvSMSMain();
                                    break;
    ...
    function JSvSMSMain(){
        ...
        $.ajax({
            ...
            success : function(tView){
                ...
                $('#odvContentSMSSizeMain').html(tView);
                JSvSMSList(1);
                JSxSMLNavDefult();
    ...
    function JSvCallPageSmartlockerSizeAdd() {
        ...
        $.ajax({
            ...
            success: function(tResult) {
                ...
                $('#odvContentSMSSizeMain').html(tResult);
