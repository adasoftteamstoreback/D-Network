        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="form-group" style="cursor:not-allowed">
                                    ...
                                    <input type="text" class="form-control xWTooltipsBT xCNInputWithoutSpcNotThai xCNInputWithoutSingleQuote" id="oetTAXDocNo" name="oetTAXDocNo" maxlength="20" value="" placeholder="<?= language('document/taxinvoice/taxinvoice', 'tTAXDocNoNew'); ?>" style="pointer-events:none" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control xCNDatePicker xCNInputMaskDate" id="oetTAXDocDate" name="oetTAXDocDate" value="<?= date('Y-m-d'); ?>" placeholder="YYYY-MM-DD">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control xCNTimePicker" id="oetTAXDocTime" name="oetTAXDocTime" value=<?= date('H:i:s') ?> placeholder="H:i:s">
                                        <span class="input-group-btn">
            ...
            <div class="panel panel-default" style="margin-bottom: 25px;">
                ...
                <div id="odvTWIDataConditionREF" class="xCNMenuPanelData panel-collapse collapse in" role="tabpanel">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="xCNLabelFrm"><?= language('document/taxinvoice/taxinvoice', 'อ้างอิงเอกสารก่อนหน้า'); ?></label>
                            <input
                                type="text"
                                class="form-control"
                                id="oetTAXRefIntDoc"
            ...
            <div class="panel panel-default" style="margin-bottom: 25px;">
                <div id="odvSOReferenceDoc" class="panel-heading xCNPanelHeadColor" role="tab" style="padding-top:10px;padding-bottom:10px;">
                    ...
                    <a class="xCNMenuplus" role="button" data-toggle="collapse" href="#odvSODataFile" aria-expanded="true">
                        <i class="fa fa-plus xCNPlus"></i>
                    </a>
                </div>
                <div id="odvSODataFile" class="xCNMenuPanelData panel-collapse collapse in" role="tabpanel">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="odvTAXShowDataTable"></div>
                        </div>
                    </div>
                </div>
                <?php
                    ...
                    <div class="panel panel-default" style="margin-bottom:25px;position:relative;min-height:200px;">
                        <div class="panel-collapse collapse in" role="tabpanel">
                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="custom-tabs-line tabs-line-bottom left-aligned">
                                            <ul class="nav" role="tablist">
                                                ...
                                                <li class="xWMenu active xCNStaHideShow" style="cursor:pointer;">
                                                    <a role="tab" data-toggle="tab" data-target="#odvTAXContentProduct" aria-expanded="true"><?= language('document/expenserecord/expenserecord', 'ข้อมูลสินค้า') ?></a>
                                                </li>

                                                <!-- อ้างอิง -->
                                                <li class="xWMenu xCNStaHideShow" style="cursor:pointer;">
                                                    <a role="tab" data-toggle="tab" data-target="#odvTAXContentHDRef" aria-expanded="false"><?= language('document/expenserecord/expenserecord', 'เอกสารอ้างอิง') ?></a>
                                                </li>
                                ...
                                <div id="odvTAXContentProduct" class="tab-pane fade active in" style="padding: 0px !important;">
                                        ...
                                        <div style="margin-top: 10px;">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-lg-7">
                                                        <div class="input-group">
                                                            <input class="form-control xCNInpuTXOthoutSingleQuote" type="text" id="oetTAXSearchPDT" name="oetTAXSearchPDT" placeholder="<?= language('document/taxinvoice/taxinvoice', 'tTAXSearach') ?>" autocomplete="off" onkeypress="Javascript:if(event.keyCode==13 ) JSxRanderHDDT('',1)">
                                                            <span class="input-group-btn">
                                ...
                                <!-- อ้างอิง -->
                                <div id="odvTAXContentHDRef" class="tab-pane fade" style="padding: 0px !important;">
                                    <div class="row p-t-15">
                                        <!-- <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right">
                                                <div style="margin-top:-2px;">
                                                    <button type="button" id="obtTAXAddDocRef" class="xCNBTNPrimeryPlus xCNDocBrowsePdt xCNHideWhenCancelOrApprove">+</button>
                                                </div>
                                            </div> -->
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right">
                                            <div style="margin-top:10px;">
                                                <div id="odvTAXDocRefMulti"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!--- ============================================================== ยกเลิกใบกำกับภาษี =============================================== -->
<div id="odvTAXModalCancelETax" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
...
<script>
    ...
    function JCNxSearchBrowseABB(pnPage) {
        ...
        var oCallDataTableFile = {
            ptElementID: 'odvTAXShowDataTable',
            ptBchCode: $('#oetBrowseBchCode').val(),
            ptDocNo: $('#oetTAXDocNo').val(),
            ptDocKey: 'TPSTTaxHD',
            ptSessionID: '<?= $this->session->userdata("tSesSessionID") ?>',
            pnEvent: <?= $nEventUpdFile ?>,
            ptCallBackFunct: '',
            ptStaApv: $('#ohdTAXApvType').val(),
            ptStaDoc: $('#ohdTAXStaDoc').val()
            //JSxSoCallBackUploadFile -- ดูข้อมูลไฟล์แนบ
        }
        JCNxUPFCallDataTable(oCallDataTableFile);
    }
    ...
    function JSxRanderHDDT(ptDocumentNumber, pnPage) {
        ...
        $.ajax({
            ...
            success: function(oResult) {
                ...
                $('#odvTAXDocRefMulti').html(tHTML['tContentDocRef']);
                JCNxCloseLoading();
    ...
    function JSxRanderAddress(ptDocumentABB, ptCustomer, ptNameCustomer) {
        $.ajax({
            ...
            data: {
                'tDocumentNumber': ptDocumentABB,
                'tCustomer': ptCustomer
            },
            cache: false,
            Timeout: 0,
            success: function(oResult) {
    ...
    function JSxRanderHDDTPreview() {
        ...
        $.ajax({
            ...
            success: function(oResult) {
                ...
                $('#oetTAXABBCode').val(aHD.DOCNOREFEXT);
                $('#oetTAXCusName').val('');
                $('#oetTAXCusCode').val('');
                $('#otaTAXRemark').text('');
