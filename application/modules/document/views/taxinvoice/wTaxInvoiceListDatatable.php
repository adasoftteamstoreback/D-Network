            ...
            <table class="table table-striped">
                <thead>
                    <tr class="xCNCenter">
                        ...
                        <th nowrap class="xCNTextBold" ><?=language('document/taxinvoice/taxinvoice','เลขที่เอกสารอ้างอิง')?></th>
                        <th nowrap class="xCNTextBold" ><?=language('document/taxinvoice/taxinvoice','วันที่เอกสารอ้างอิง')?></th>
                                    ...
                                    <?php
                                        switch($aValue['FTXshStaDoc']){
                                            case '1':
                                                ...
                                                break;
                                            case '2':
                                                $tXshStaDocName = "ไม่สมบูรณ์"; /*ไม่สมบูรณ์*/
                                                break;
                                            case '3':
                                                $tXshStaDocName = "ยกเลิก(ไม่ใช้งาน)"; /*ยกเลิก(ไม่ใช้งาน)*/
                                                break;
                                            case '4':
                                                $tXshStaDocName = "ยกเลิก(ใช้งาน)"; /*ยกเลิก(ใช้งาน)*/
                                                break;
                                            case '5':
                                                $tXshStaDocName = "แก้ไข"; /*แก้ไข*/
                                                break;
                                        }
                                        echo $tXshStaDocName;
                                    ?>
