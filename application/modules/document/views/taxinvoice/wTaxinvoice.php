...
<input id="oetCheckJumpDocno"       type="hidden" value="<?= @$aParams['tDocNo'] ?>">
<input id="oetCheckJumpBchno"       type="hidden" value="<?= @$aParams['tBchCode'] ?>">
                    ...
                    <div class="xCNBtngroup" style="width:100%;">
                        <div>
                            <div style="width:100%;">
                                ...
                                <!-- <button class="btn xCNBTNDefult xCNBTNDefult2Btn xCNHide" type="button" hidden id="obtPrintPreviewDocument" onclick="JSxTaxPrintPreviewDoc();"><?=language('document/taxinvoice/taxinvoice', 'tTAXPrintPreview'); ?></button> -->
...
<script>
    $('document').ready(function() {
        ...
        var tJumpDocNo = $("#oetCheckJumpDocno").val();
        var tJumpBchNo = $("#oetCheckJumpBchno").val();
        ...
        switch(nBrowseType){
            ...
            default:
                ...
                if($('#oetCheckJumpStatus').val() != '1'){
                    ...
                    JSvTAXLoadPageAddOrPreview(tJumpBchNo,tJumpDocNo); 
                }
        }
        ...
        if(tCode == ''){
            ...
            $.ajax({
                ...
                success : function (tResult) {
                    ...
                    window.open("<?=base_url(); ?>formreport/Frm_PSInvoiceSale_Back_ABB?infor=" + JCNtEnCodeUrlParameter(aInfor) + "&Grand="+tGrandText, '_blank');
