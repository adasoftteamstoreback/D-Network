<?php
    ...
    if(isset($aDataDocHD) && $aDataDocHD['rtCode'] == '1'){
        ...
        $nStaUploadFile          = 2;
        $nTRBStaDocAct           = $aDataDocHD['rnXthStaDocAct'];
        $tStaDocRef              = $aDataDocHD['rtStaDocRef'];
        $nTRBStaRefKey              = $aDataDocHD['FTXshRefType'];
    }else{
...
?>
<style type="text/css">
    #odvRowDataEndOfBill .panel-heading{ padding-top : 10px !important; padding-bottom : 10px !important;} #odvRowDataEndOfBill .panel-body{ padding-top : 0px !important; padding-bottom : 0px !important;} #odvRowDataEndOfBill .list-group-item{ padding-left : 0px !important; padding-right : 0px !important; border : 0px solid #ddd;}
</style>
<form id="ofmTRBFormAdd" class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" id="ohdTRBStaRefKey" name="ohdTRBStaRefKey" value="<?php echo $nTRBStaRefKey;?>">
    ...
    <!-- Input Check Status Cancel -->
    <input type="hidden" id="ohdTRBAutStaCancel"    name="ohdTRBAutStaCancel"   value="<?=@$aAlwEvent['tAutStaCancel'];?>">
    <input type="hidden" id="ohdTRBDocDateCreate"   name="ohdTRBDocDateCreate"  value="<?=date("m",strtotime($dTRBDocDate));?>">
    <input type="hidden" id="ohdTRBDocDateToday"    name="ohdTRBDocDateToday"   value="<?=date('m');?>">
    
    <!-- <input type="hidden" id="ohdTWOnStaDocRef" name="ohdTWOnStaWasteWAH" value="<?= $tStaDocRef ?>"> -->
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="form-group m-b-0">
                                ...
                                <!--Agn Bch-->
                                <?php
                                    $tTRBDataInputBchCode_To   = "";
                                    $tTRBDataInputBchName_To   = "";
                                    if($tTRBRoute  == "docTRBEventAdd"){
                                        ...
                                        $tTRBDataInputBchCode_To    = $tTRBBchCodeTo;
                                        $tTRBDataInputBchName_To    = $tTRBBchNameTo;
                                        $tUserWahCode_To            = $tTRBWahCodeTo;
		                                $tUserWahName_To            = $tTRBWahNameTo;
                                        $tDisabledBch_To            = 'disabled';
                                    }
                                ?>
                                <div class="form-group">
                                    <label class="xCNLabelFrm"><span style = "color:red">*</span><?php echo language('document/transferrequestbranch/transferrequestbranch', 'tTRBLabelFrmBranch')?></label>
                                        <div class="input-group">
                                            ...
                                            <input
                                                ...
                                                placeholder="<?php echo language('document/transferrequestbranch/transferrequestbranch', 'tTRBLabelFrmBranch')?>"
                                                data-validate-required="<?php echo language('document/transferrequestbranch/transferrequestbranch','tTRBPlsEnterBch'); ?>"
                                                value="<?=$tTRBDataInputBchName_To?>"
                                                readonly
                                            >
                                            <span class="input-group-btn xWConditionSearchPdt">
                                                <button id="obtTRBBrowseBCHTo" type="button" class="btn xCNBtnBrowseAddOn " <?= @$tDisabledBch_To ?>>
                                                    <img src="<?php echo  base_url().'/application/modules/common/assets/images/icons/find-24.png'?>">
                                                </button>
                                            </span>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control xControlForm xCNHide" id="oetTRBFrmWahCodeTo" name="oetTRBFrmWahCodeTo" maxlength="5" value="<?=$tUserWahCode_To?>">
                                        <input
                                            type="text"
                                            class="form-control xControlForm xWPointerEventNone"
                                            id="oetTRBFrmWahNameTo"
                                            name="oetTRBFrmWahNameTo"
                                            value="<?=$tUserWahName_To?>"
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="form-group m-b-0">
                                ...
                                <!--Agn Bch-->
                                <?php
                                    $tTRBDataInputBchCode_Frm   = "";
                                    $tTRBDataInputBchName_Frm   = "";
                                    if($tTRBRoute  == "docTRBEventAdd"){
                                        if($this->session->userdata('tSesUsrLevel') == 'HQ'){
                                            $tTRBDataInputBchCode_Frm    = '';
                                            $tTRBDataInputBchName_Frm    = '';
                                            ...
                                            $tTRBDataInputBchCode_Frm    = $this->session->userdata('tSesUsrBchCodeDefault');
                                            $tTRBDataInputBchName_Frm    = $this->session->userdata('tSesUsrBchNameDefault');
                                            $tUserWahCode_Frm            = $this->session->userdata('tSesUsrWahCode');
                                            $tUserWahName_Frm            = $this->session->userdata('tSesUsrWahName');
                                            $tDisabledBch_Frm            = '';
                                        }
                                    }else{
                                        $tTRBDataInputBchCode_Frm    = $tTRBBchCodeShip;
                                        $tTRBDataInputBchName_Frm    = $tTRBBchNameShip;
                                        $tUserWahCode_Frm            = $tTRBWahCodeShip;
		                                $tUserWahName_Frm            = $tTRBWahNameShip;
                                        $tDisabledBch_Frm            = 'disabled';
                                    }
                                ?>
                                ...
                                <div class="form-group" style="display:none;">
                                    ...
                                    <div class="input-group"><input type="text" class="form-control xControlForm xCNHide" id="oetTRBAgnCodeShip" name="oetTRBAgnCodeShip" maxlength="5" value="<?=$tTRBAgnCodeShip?>">
                                        <input  type="text"
                                                ...
                                                readonly>
                                        <span class="input-group-btn">
                                            <button id="oimTRBBrowseAgnShip" type="button" class="btn xCNBtnBrowseAddOn " <?= @$tDisabledBch_Frm ?>>
                                                <img src="<?php echo  base_url() . '/application/modules/common/assets/images/icons/find-24.png' ?>">
                                            </button>
                                        </span>
                                    </div>
                                    ...
                                    <label class="xCNLabelFrm"><span style = "color:red">*</span><?php echo language('document/transferrequestbranch/transferrequestbranch', 'tTRBLabelFrmBranch')?></label>
                                        <div class="input-group">
                                            <input
                                                ...
                                                maxlength="5"
                                                value="<?=$tTRBDataInputBchCode_Frm?>"
                                            >
                                            <input
                                                type="text"
                                                class="form-control xControlForm xWPointerEventNone"
                                                ...
                                                placeholder="<?php echo language('document/transferrequestbranch/transferrequestbranch', 'tTRBLabelFrmBranch')?>"
                                                data-validate-required="<?php echo language('document/transferrequestbranch/transferrequestbranch','tTRBPlsEnterBch'); ?>"
                                                value="<?=$tTRBDataInputBchName_Frm?>"
                                                readonly
                                            >
                                            <span class="input-group-btn xWConditionSearchPdt">
                                                <button id="obtTRBBrowseBCHShip" type="button" class="btn xCNBtnBrowseAddOn " <?= @$tDisabledBch_Frm ?>>
                                                    <img src="<?php echo  base_url().'/application/modules/common/assets/images/icons/find-24.png'?>">
                                                </button>
                                            </span>
                                        </div>
                                ...
                                <div class="form-group" style="display: none;">
                                    <label class="xCNLabelFrm"><span style = "color:red">*</span><?php echo language('document/transferrequestbranch/transferrequestbranch','tTRBLabelFrmWah');?></label>
                                    <div class="input-group">
                                        <input type="text" class="form-control xControlForm xCNHide" id="oetTRBFrmWahCodeShip" name="oetTRBFrmWahCodeShip" maxlength="5" value="<?=$tUserWahCode_Frm?>">
                                        <input
                                            type="text"
                                            class="form-control xControlForm xWPointerEventNone"
                                            id="oetTRBFrmWahNameShip"
                                            name="oetTRBFrmWahNameShip"
                                            value="<?=$tUserWahName_Frm?>"
                                            data-validate-required="<?php echo language('document/transferrequestbranch/transferrequestbranch','tTRBPlsEnterWah'); ?>"
                                            placeholder="<?php echo language('document/transferrequestbranch/transferrequestbranch','tTRBLabelFrmWah');?>"
                                            readonly
                                        >
                    ...
                    <div class="panel panel-default" style="margin-bottom:25px;position:relative;">
                        <div class="panel-collapse collapse in" role="tabpanel" data-grpname="Condition">
                            <div class="panel-body">
                                ...
                                <div class="row p-t-10" id="odvTRBDataPdtTableDTTemp">
                                </div>
                            <!--ส่วนสรุปท้ายบิล-->
...
<div id="odvTRBModalRefIntDoc" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document" style="width: 1200px;">
        <div class="modal-content">
            ...
            <div class="modal-header xCNModalHead">
                <label class="xCNTextModalHeard"><?php echo language('document/purchaseorder/purchaseorder','อ้างอิงเอกสารใบสั่งสินค้าจากสาขา')?></label>
            </div>

            <div class="modal-body">
                <div class="row" id="odvTRBFromRefIntDoc"></div>
            </div>
...
<script type="text/javascript">
    ...
    function JCNSearchBarcodePdt(ptTextScan){
        ...
        var tWhereCondition = " AND FTPdtStkControl = 1 ";
        // if( tPISplCode != "" ){
