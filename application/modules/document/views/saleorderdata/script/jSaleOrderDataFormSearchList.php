<script type="text/javascript">
    ...
    $('#obtSODSearchReset').unbind().click(function(){
        var nStaSession = JCNxFuncChkSessionExpired();
        if(typeof(nStaSession) !== 'undefined' && nStaSession == 1){
            JSxSODClearAdvSearchData();
        }else{
            JCNxShowMsgSessionExpired();
        }
    });
    ...
    // ReturnType: -
    function JSxSODClearAdvSearchData(){
        var nStaSession = JCNxFuncChkSessionExpired();
        if(typeof nStaSession !== "undefined" && nStaSession == 1){
    ...
    // ====================================================  From Search Data Page Purchase Invioce ====================================================
        ...
        $("#obtSODAdvSearchSubmitForm").unbind().click(function(){
            var nStaSession = JCNxFuncChkSessionExpired();
            if(typeof nStaSession !== "undefined" && nStaSession == 1){
                JSvSODCallPageDataTable();
            }else{
        ...
        $('#oetSODSearchSoNo').on('keydown',function(){
            if(event.keyCode == 13){
                var nStaSession = JCNxFuncChkSessionExpired();
            if(typeof nStaSession !== "undefined" && nStaSession == 1){
                JSvSODCallPageDataTable();
