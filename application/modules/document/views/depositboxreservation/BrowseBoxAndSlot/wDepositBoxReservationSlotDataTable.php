                ...
                <tbody>
                    <?php if($aDataList['rtCode'] == 1 ):?>
                        <?php foreach($aDataList['raItems'] AS $nKey => $aValue): ?>
                            <?php
                                if ($tDBRDocType == 1) {
                                    $tDBRDocNo  = $aValue['FTXphDocNo'];
                                    $tDBRStaDoc  = $aValue['FTXphStaDoc'];
                                    $tDBRStaRef  = $aValue['FNXphStaRef'];
                                    $tDBRStaApv  = $aValue['FTXphStaApv'];
                                    $tDBRDocDate  = $aValue['FDXphDocDate'];
                                    $tDBRDocTime  = $aValue['FTXshDocTime'];
                                    $tDBRVATInOrEx  = $aValue['FTXphVATInOrEx'];
                                    $tDBRCrTerm  = $aValue['FNXphCrTerm'];
                            ...
                            <tr style="cursor:pointer;" class="text-center xCNTextDetail2 xWPIDocItems xPurchaseInvoiceRefInt" 
                                ...
                                data-vatinroex="<?php echo $tDBRVATInOrEx?>"
                                data-crtrem="<?php echo $tDBRCrTerm?>"
