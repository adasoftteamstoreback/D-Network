...
<input id="oetTRNJumpDocNo" type="hidden" value="<?php echo $aParams['tDocNo'] ?>">
<input id="oetTRNJumpBchCode" type="hidden" value="<?php echo $aParams['tBchCode'] ?>">
<input id="oetTRNJumpAgnCode" type="hidden" value="<?php echo $aParams['tAgnCode'] ?>">
