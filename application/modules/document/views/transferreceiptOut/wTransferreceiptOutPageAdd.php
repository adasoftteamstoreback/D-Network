...
<form id="ofmTransferreceiptFormAdd" class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" id="ohdTWIDocDateCreate"   name="ohdTWIDocDateCreate"  value="<?=@$dTWIDocDate;?>">
    <inpuy type="hidden" id="ohdTWIDateNowToday"    name="ohdTWIDateNowToday"   value="<?=date('Y-m-d');?>">
