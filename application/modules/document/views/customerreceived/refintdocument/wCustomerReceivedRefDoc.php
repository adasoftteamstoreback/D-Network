...
<section>
            ...
            <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPOLabelFrmBranch')?></label>
                <div class="input-group">
                    <input
                        ...
                        id="oetCRVRefIntBchCode"
                        name="oetCRVRefIntBchCode"
                        maxlength="5"
                        value="<?=$tBCHCode?>"
                        data-bchcodeold = ""
                    >
                    <input
                        ...
                        id="oetCRVRefIntBchName"
                        name="oetCRVRefIntBchName"
                        maxlength="100"
                        value="<?=$tBCHName?>"
                        readonly
                    >
                    ...
                    <span class="input-group-btn xWConditionSearchPdt">
                        <button id="obtCRVBrowseBchRefIntDoc" type="button" class="btn xCNBtnBrowseAddOn "    >
        ...
        <div class="form-group">
            <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPOTBDocNo')?></label>
                <input
                    type="text"
                    class="form-control"
                    id="oetCRVRefIntDocNo"
                    name="oetCRVRefIntDocNo"
                    maxlength="100"
                    value=""
        ...
        <div class="form-group">
                    <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPORefIntDocDateFrm')?></label>
                            ...
                            <input
                                ...
                                id="oetCRVRefIntDocDateFrm"
                                name="oetCRVRefIntDocDateFrm"
                                placeholder="YYYY-MM-DD"
                                value=""
                            >
                            <span class="input-group-btn">
                                <button id="obtCRVBrowseRefExtDocDateFrm" type="button" class="btn xCNBtnDateTime"><img class="xCNIconCalendar"></button>
                            </span>
                        </div>
                    </div>
        </div>
            ...
            <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPORefIntDocDateTo')?></label>
                <div class="input-group">
                    <input
                        type="text"
                        class="form-control xCNDatePicker xCNInputMaskDate"
                        id="oetCRVRefIntDocDateTo"
                        name="oetCRVRefIntDocDateTo"
                        placeholder="YYYY-MM-DD"
                        value=""
                    >
                    <span class="input-group-btn">
                        <button id="obtCRVBrowseRefExtDocDateTo" type="button" class="btn xCNBtnDateTime"><img class="xCNIconCalendar"></button>
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-2 col-xs-2 col-sm-2">
        <div class="form-group">
            ...
            <select class="selectpicker form-control  " id="oetCRVRefIntStaDoc" name="oetCRVRefIntStaDoc" maxlength="1" value="<?php echo $tCRVSplPayMentType;?>">
