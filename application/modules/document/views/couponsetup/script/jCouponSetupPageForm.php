...
<script type="text/javascript">
    ...
    var oCHDPriceAdOption = function(poReturnInputCstPri){
        ...
        let oOptionReturnHDCstPri    = {
            ...
            Where : {
                Condition : [' AND TCNTPdtAdjPriHD.FTXphDocType = 4 AND TCNTPdtAdjPriHD.FTXphStaApv = 1']
            },
            GrideView:{
                ColumnPathLang	: 'coupon/coupontype/coupontype',
                ColumnKeyLang	: ['tCPTPriDocno','tCPTPriDate'],
                ColumnsSize     : ['50%','50%'],
                WidthModal      : 50,
                DataColumns		: ['TCNTPdtAdjPriHD.FTXphDocNo','TCNTPdtAdjPriHD.FDXphDocDate'],
                DataColumnsFormat : ['',''],
                Perpage			: 10,
                OrderBy			: ['TCNTPdtAdjPriHD.FTXphDocNo ASC'],
            },
            CallBack:{
                ReturnType	: 'S',
