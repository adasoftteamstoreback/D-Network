...
<input id="oetCheckJumpBchCode"       type="hidden" value="<?= @$aParams['tBchcode'] ?>">
						...
						<div id="odvABBBtnAddEdit">
                            <div class="demo-button xCNBtngroup" style="width:100%;">
                                ...
                                <?php if ($aPermission['tAutStaFull'] == 1 || ($aPermission['tAutStaAdd'] == 1 || $aPermission['tAutStaEdit'] == 1)): ?>
                                    ...
                                    <button id="obtABBDownloadDoc" 	class="btn xCNBTNDefult xCNBTNDefult2Btn" 	type="button" > <?=language('document/abbsalerefund/abbsalerefund', 'tABBBtnDownloadABB'); ?></button>
                                    <button id="obtABBDownloadFullTax" class="btn xCNBTNDefult xCNBTNDefult2Btn" type="button"> <?=language('document/abbsalerefund/abbsalerefund', 'tABBBtnDownloadFullTax'); ?></button>
                                <?php endif; ?>
                            </div>
						</div>
					</div>
