                ...
                <div id="odvAdjStkSubSubWarehousePanel" class="panel-collapse collapse in" role="tabpanel">
                    <div class="panel-body xCNPDModlue">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker xWConditionSearchPdt" id="ocmAdjStkOptionAddPdt" name="ocmAdjStkOptionAddPdt">
                ...
                <!-- <div class="panel-collapse collapse in" role="tabpanel" data-grpname="Condition"> -->
                    <div class="panel-body xCNPDModlue">
                        ...
                        <div class="row" style="margin-top: 10px;">
                            ...
                            <div class="col-md-6">
                                <div class="right">
                                    <div id="odvAdjStkSubMngAdvTableList" class="btn-group xCNDropDrownGroup" >
                                            <button type="button" class="btn xCNBTNMngTable xCNImportBtn"  onclick="JSxAdjStkSubOpenImportForm()">
