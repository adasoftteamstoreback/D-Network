<div class="panel panel-headline">
    <div class="panel-heading">
        ...
        <!--ค้นหาขั้นสูง-->
        <div class="row hidden" id="odvIVAdvanceSearchContainer" style="margin-bottom:20px;">
            ...
            <div class="col-xs-12 col-sm-6 col-md-2 col-lg-3">
                <div class="form-group" style="width: 60%;">
                    ...
                    <button id="oahIVAdvanceSearchSubmit" class="btn xCNBTNPrimery" style="width:100%" onclick="JSvIVCallPageDataTable()"><?=language('common/main/main', 'tSearch'); ?></button>
                </div>
            </div>
        </div>
    </div>
