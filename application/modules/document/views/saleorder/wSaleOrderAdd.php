...
<div id="odvPCKModalAppoveDoc" class="modal fade">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <strong><h5 class="xCNHeardModal modal-title" style="display:inline-block"><?php echo language('document/saleorder/saleorder', 'tSOCreatePCKTitlt'); ?></strong></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p><?php echo language('document/saleorder/saleorder', 'tSOCreatePCKlabel'); ?></p>
                <ul>
                <div class="form-group">
					<label class="fancy-checkbox">
						<input type="checkbox" id="ocbPCKCheckWah" value="1" name="ocbPCKCheckWah">
						<span><?php echo language('document/saleorder/saleorder', 'tSOCreatePCKlabelWah') ?></span>
					</label>
				</div>
                <div class="form-group">
					<label class="fancy-checkbox">
						<input type="checkbox" id="ocbPCKChkCat1" value="1" name="ocbPCKChkCat1">
						<span><?php echo language('document/saleorder/saleorder', 'tSOCreatePCKlabelCat').'1' ?></span>
					</label>
				</div>
                <div class="form-group">
					<label class="fancy-checkbox">
						<input type="checkbox" id="ocbPCKChkCat2" value="1" name="ocbPCKChkCat2">
						<span><?php echo language('document/saleorder/saleorder', 'tSOCreatePCKlabelCat').'2' ?></span>
					</label>
				</div>
                <div class="form-group">
					<label class="fancy-checkbox">
						<input type="checkbox" id="ocbPCKChkCat3" value="1" name="ocbPCKChkCat3">
						<span><?php echo language('document/saleorder/saleorder', 'tSOCreatePCKlabelCat').'3' ?></span>
					</label>
				</div>
                <div class="form-group">
					<label class="fancy-checkbox">
						<input type="checkbox" id="ocbPCKChkCat4" value="1" name="ocbPCKChkCat4">
						<span><?php echo language('document/saleorder/saleorder', 'tSOCreatePCKlabelCat').'4' ?></span>
					</label>
				</div>
                <div class="form-group">
					<label class="fancy-checkbox">
						<input type="checkbox" id="ocbPCKChkCat5" value="1" name="ocbPCKChkCat5">
						<span><?php echo language('document/saleorder/saleorder', 'tSOCreatePCKlabelCat').'5' ?></span>
					</label>
				</div>
                </ul>
            </div>
            <div class="modal-footer">
                <button onclick="JSxSOCreatePCKDocument(true)" type="button" class="btn xCNBTNPrimery">
                    <?php echo language('common/main/main', 'tModalConfirm'); ?>
                </button>
                <button type="button" class="btn xCNBTNDefult" data-dismiss="modal">
                    <?php echo language('common/main/main', 'tModalCancel'); ?>
...
<!-- ======================================================================== Modal สต็อกไม่เพียงพอ  ======================================================================== -->
<div id="odvDBRModalStockNotMatch" class="modal fade" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-lg">
            <div class="modal-header">
                <h5 class="xCNHeardModal modal-title" style="display:inline-block"><?php echo language('common/main/main', 'สต็อกสินค้าไม่เพียงพอ'); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <thead>
                <tr class="xCNCenter">
                    ...
                    <th class="xCNTextBold"><?=language('document/depositboxreservation/depositboxreservation','จำนวนคงเหลือ')?></th>
                    <th class="xCNTextBold"><?=language('document/depositboxreservation/depositboxreservation','จำนวนสั่ง')?></th>
                </tr>
            </thead>
            <tbody id="odvTBodySOStockNotMatchList">
