                ...
                <div class="demo-button xCNBtngroup" style="width:100%;">
                    ...
                    <div id="odvPAMBtnGrpAddEdit">
                        <div class="demo-button xCNBtngroup" style="width:100%;">
                            ...
                            <button id="obtPAMBooking" onClick="JSvSODJumptoCreateBook()" class="btn xCNBTNDefult xCNBTNDefult2Btn" type="button"> <?=language('common/main/main', 'จองช่องฝาก'); ?></button>
