                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group"><input type="text" class="form-control xControlForm xCNHide" id="oetPAMBchCode" name="oetPAMBchCode" maxlength="5" value="<?=$tPAMDataInputBchCode?>">
                                        <input type="text" class="form-control xControlForm xWPointerEventNone" id="oetPAMBchName" name="oetPAMBchName" maxlength="100" placeholder="<?php echo language('document/productarrangement/productarrangement', 'tDocBchCreate') ?>" value="<?=$tPAMDataInputBchName?>" readonly>
                                        <span class="input-group-btn">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="custom-tabs-line tabs-line-bottom left-aligned">
                                            <ul class="nav" role="tablist">
                                                ...
                                                <!-- อ้างอิง -->
                                                <li class="xWMenu xWSubTab xCNStaHideShow" style="cursor:pointer;" onclick="JSxPAMCallPageHDDocRef()">
...
<!-- =========================================== View Modal Chk Qty And QtyOld  =========================================== -->
<div id="odvPAMModalQtyOld" class="modal fade">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="xCNHeardModal modal-title" style="display:inline-block"><?php echo language('common/main/main', 'tApproveTheDocument'); ?></h5>
            ...
            <div class="modal-body">
                <p><?php echo language('common/main/main', 'เมื่อกดยืนยันค่าที่เป็น 0 จะเท่าจำนวนสั่ง ยืนยันที่จะดำเนินการต่อหรือไม่'); ?></p>
            </div>
            <div class="modal-footer">
                <button onclick="JSxPAMSubmitChangeQTY()" type="button" class="btn xCNBTNPrimery">
                    <?php echo language('common/main/main', 'tModalConfirm'); ?>
                </button>
                <button type="button" class="btn xCNBTNDefult" data-dismiss="modal">
                    <?php echo language('common/main/main', 'tModalCancel'); ?>
...
<!-- =========================================== View Modal Chk Qty And QtyOld  =========================================== -->
<div id="odvPAMModalQtyOld2" class="modal fade">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="xCNHeardModal modal-title" style="display:inline-block"><?php echo language('common/main/main', 'tApproveTheDocument'); ?></h5>
            ...
            <div class="modal-footer">
                <button onclick="JSxPAMSubmitChangeQTY2()" type="button" class="btn xCNBTNPrimery">
                    <?php echo language('common/main/main', 'tModalConfirm'); ?>
                </button>
                <button type="button" class="btn xCNBTNDefult" data-dismiss="modal">
                    <?php echo language('common/main/main', 'tModalCancel'); ?>
