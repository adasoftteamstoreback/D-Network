...
<input id="oetASTJumpDocNo"         type="hidden"   value="<?php echo $aParams['tDocNo'] ?>">
<input id="oetASTJumpBchCode"       type="hidden"   value="<?php echo $aParams['tBchCode'] ?>">
<input id="oetASTJumpAgnCode"       type="hidden"   value="<?php echo $aParams['tAgnCode'] ?>">

<?php if(isset($nBrowseType) &&  ( $nBrowseType == 0 || $nBrowseType ==2)) : ?>
...
<?php endif;?>
<script type="text/javascript" src="<?php echo base_url() ?>application/modules/document/assets/src/adjuststock/jAdjustStock.js?v=1"></script>