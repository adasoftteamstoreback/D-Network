<script>
    ...
    $(document).ready(function(){
        ...
        var oParameterSend = {
            ...
            "TableID" : "otbPAMDocPdtAdvTableList",
        ...
        if(bIsApvOrCancel){
            $('#otbPAMDocPdtAdvTableList .xCNApvOrCanCelDisabledPdt').attr('disabled', true);
            $('#otbPAMDocPdtAdvTableList .xCNIconDel').addClass('xCNDocDisabled');
            $('#otbPAMDocPdtAdvTableList .xCNIconDel').removeAttr('onclick', true);
        }else{
            $('#otbPAMDocPdtAdvTableList .xCNApvOrCanCelDisabledPdt').attr('disabled', false);
            $('#otbPAMDocPdtAdvTableList .xCNIconDel').removeClass('xCNDocDisabled');
            $('#otbPAMDocPdtAdvTableList .xCNIconDel').attr('onclick', 'JSxTransferBchOutPdtDataTableDeleteBySeq(this)');
        }
