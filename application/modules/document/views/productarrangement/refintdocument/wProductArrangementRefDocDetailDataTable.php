    ...
    <table class="table xRefIntTable" id="otbPAMRefPoDocDetail">
        <thead >
            <tr>
                ...
                <th class="xRefIntTh text-right" hidden><?php echo language('document/purchaseorder/purchaseorder','tPOTable_qtyLeft');?></th>
            </tr>
        </thead>
        <tbody>
            <?php if($aDataList['rtCode'] == 1 ):?>
                <?php foreach($aDataList['raItems'] AS $nKey => $aValue): ?>
                    ...
                    >
                        ...
                        <td class="xRefIntTd text-right" hidden><?=number_format($aValue['FCXpdQty'],$nOptDecimalShow)?></td>
                    </tr>
                <?php endforeach;?>
            <?php else:?>
