    ...
    function FSvPAMAddPdtIntoDocDTTemp(ptPdtData){
        ...
        for(var i=0; i<nLen; i++){
            ...
            if(tDuplicate == true && InfoOthReAddPdt==1){
                ...
                //tHTML += '<td>'+nQty+'</td>';
              //  tHTML += '<td class="otdRmk">';
                //tHTML += '<div class="xWEditInLineRmk1">';
                //tHTML += '<input type="text" class="xCNRmk form-control xCNPdtEditInLine text-left xWRemarkEditInLine1" id="ohdRmk'+nKey+'" name="ohdRmk'+nKey+'" data-seq="1" maxlength="200" value="" autocomplete="off">';
                //tHTML += '</div>';
                tHTML += '</td>';
