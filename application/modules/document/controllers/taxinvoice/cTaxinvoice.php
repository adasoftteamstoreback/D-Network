...
class cTaxInvoice extends MX_Controller
{
    ...
    public function index($nBrowseType, $tBrowseOption){
        ...
        $aData['aParams']['tCheckJump']    = $this->input->post('ptTypeJump');
    ...
    public function FSvCTAXLoadDatatable(){
        ...
        if($tDocumentNumber == '' || $tDocumentNumber == null){
            ...
            $aGetHDDocRef   = $this->mTaxinvoice->FSaMTAXGetHDDocRef($aWhere);
        }
        ...
        $aReturnData = array(
            ...
            'tContentDocRef'      => $this->load->view('document/taxInvoice/wTaxinvoiceDatatableDocRef',$aGetHDDocRef, true),
            'aDetailHD'           => $aGetHD,
    ...
    public function FSxCTAXCallTaxNoLastDoc(){
        ...
        if( $tTaxJsonString != 'false' ){
            ...
            if( $nResult == 0 ){
                ...
                //Insert ลง DocRef ของ ABB กับ FULLTAX
                $this->mTaxinvoice->FSaMTAXInsertDocRef($aPackData);
                ...
                if( $aPackData['tTAXApvType'] == '2' ){ // ทำใบยกเลิกเอกสาร
                    ...
                    //Insert RefInt + RefAE
                    $this->mTaxinvoice->FSxMTAXInsertDocrefReference($aPackData);
