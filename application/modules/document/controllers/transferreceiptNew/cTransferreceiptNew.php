...
class cTransferreceiptNew extends MX_Controller{
    ...
    public function FSvCTWITransferReceiptPageEdit(){
        try {
            ...
            $this->mTransferreceiptNew->FSxMTWIMoveDTSNToDTSNTemp($aDataWhere);
    ...
    public function FSoCTWIAddEventDoc()
    {
        try {
            ...
            $aDataMaster = array(
                ...
                'FDXthRefExtDate'       => $aDataDocument['oetTWIRefExtDocDate'] == '' ? NULL : date("Y-m-d", strtotime($aDataDocument['oetTWIRefExtDocDate'])),

                'FTXthRefInt'           => $aDataDocument['oetTWIRefIntDocCode'],
                'FDXthRefIntDate'       => $aDataDocument['oetTWIRefIntDocDate'] == '' ? NULL : date("Y-m-d", strtotime($aDataDocument['oetTWIRefIntDocDate'])),
            ...
            // Move Doc DTSNTemp To DTSN
            $this->mTransferreceiptNew->FSxMTWIMoveDTSNTmpToDTSN($aDataWhere, $aTableAddUpdate);
    ...
    public function FSoCTWIEditEventDoc()
    {
        try {
            ...
            $aDataMaster = array(
                ...
                'FTXthStaApv'           => !empty($aDataDocument['ohdTWIStaApv']) ? $aDataDocument['ohdTWIStaApv'] : NULL,
                'FTXthStaPrcStk'        => $aDataDocument['ohdTWIStaPrcStk'],
                'FTXthStaDelMQ'         => !empty($aDataDocument['ohdTWIStaDelMQ']) ? $aDataDocument['ohdTWIStaDelMQ'] : NULL,
                'FNXthStaDocAct'        => !empty($aDataDocument['ocbTWIStaDocAct']) ? $aDataDocument['ocbTWIStaDocAct'] : 0,
                'FNXthStaRef'           => null,
                'FTRsnCode'             => $aDataDocument['oetTWIReasonCode'] == '' ? null : $aDataDocument['oetTWIReasonCode'],
    ...
    public function FSoCTWIEditPdtIntoDocDTTemp()
    {
        try {
            ...
            $tTWITableName  = $this->input->post('tTWITableName');
