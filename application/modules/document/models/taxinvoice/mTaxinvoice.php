...
class mTaxinvoice extends CI_Model{
    ...
    public function FSaMTAXGetListABB($paData){
        ...
        $tSQL .= " ) AS A ";
        $tSQL .= " LEFT JOIN TPSTTaxHDDocRef HDDocRef_in WITH (NOLOCK) ON A.FTXshDocNo = HDDocRef_in.FTXshDocNo AND HDDocRef_in.FTXshRefType = 1 AND HDDocRef_in.FTXshRefKey = 'ABB' ";
    ...
    //Docref
    public function FSaMTAXInsertDocRef($aPackData){

        $this->db->where('FTXshDocNo',$aPackData['tDocABB']);
        $this->db->where('FTXshRefType','2');
        $this->db->where('FTXshRefKey','ABBFULLTAX');
        $this->db->delete('TPSTSalHDDocRef');

        /// Insert ABB Docref
        $aPackDataREF['FTBchCode'] = $aPackData['tBrowseBchCode'];
        $aPackDataREF['FTXshDocNo'] = $aPackData['tDocABB'];
        $aPackDataREF['FTXshRefDocNo'] = $aPackData['tTaxNumberFull'];
        $aPackDataREF['FTXshRefType'] = '2';
        $aPackDataREF['FTXshRefKey'] = 'ABBFULLTAX';
        $aPackDataREF['FDXshRefDocDate'] = date('Y-m-d H:i:s');
        $this->db->insert('TPSTSalHDDocRef',$aPackDataREF);

        /// Insert FULLTAX Docref
        $aPackDataFULLTAX['FTBchCode'] = $aPackData['tBrowseBchCode'];
        $aPackDataFULLTAX['FTXshDocNo'] = $aPackData['tTaxNumberFull'];
        $aPackDataFULLTAX['FTXshRefDocNo'] = $aPackData['tDocABB'];
        $aPackDataFULLTAX['FTXshRefType'] = '1';
        $aPackDataFULLTAX['FTXshRefKey'] = 'ABB';
        $aPackDataFULLTAX['FDXshRefDocDate'] = date('Y-m-d H:i:s');
        $this->db->insert('TPSTTaxHDDocRef',$aPackDataFULLTAX);
    ...
    public function FSaMTAXGetHDTax($ptData){
        ...
        $tSQL   = " SELECT 
                        DOCREF.FTXshRefDocNo AS DOCNOREFEXT,
                        Tax.* , 
                    ...
                    LEFT JOIN TPSTTaxHDDocRef DOCREF WITH(NOLOCK) ON Tax.FTXshDocNo = DOCREF.FTXshDocNo AND FTXshRefKey = 'ABB' AND FTXshRefType = '1' 
    ...
    public function FSxMTAXInsertDocrefReference($aPackData){
        $tBrowseBchCode     = $aPackData['tBrowseBchCode'];
        $tTaxNumberFull     = $aPackData['tTaxNumberFull'];
        $tCurretTaxDocNo    = $aPackData['tCurretTaxDocNo'];
        $tOriginTaxDocNo    = $aPackData['tOriginTaxDocNo'];
        ...
        if( $tOriginTaxDocNo == "" ){
            ...
            /// Insert FULLTAX Docref Origin
            $aPackDataFULLTAX['FTBchCode'] = $tBrowseBchCode;
            $aPackDataFULLTAX['FTXshDocNo'] = $tOriginTaxDocNo;
            $aPackDataFULLTAX['FTXshRefDocNo'] = $tTaxNumberFull;
            $aPackDataFULLTAX['FTXshRefType'] = '2';
            $aPackDataFULLTAX['FTXshRefKey'] = 'ABBFULLTAX';
            $aPackDataFULLTAX['FDXshRefDocDate'] = date('Y-m-d H:i:s');
            $this->db->insert('TPSTTaxHDDocRef',$aPackDataFULLTAX);

            /// Insert FULLTAX Docref FULLTAX
            $aPackDataFULLTAX['FTBchCode'] = $tBrowseBchCode;
            $aPackDataFULLTAX['FTXshDocNo'] = $tTaxNumberFull;
            $aPackDataFULLTAX['FTXshRefDocNo'] = $tOriginTaxDocNo;
            $aPackDataFULLTAX['FTXshRefType'] = '1';
            $aPackDataFULLTAX['FTXshRefKey'] = 'B4FULLTAX';
            $aPackDataFULLTAX['FDXshRefDocDate'] = date('Y-m-d H:i:s');
            $this->db->insert('TPSTTaxHDDocRef',$aPackDataFULLTAX);
            ...
            $aPackDataFULLTAX['FTXshRefDocNo'] = $tOriginTaxDocNo;
            $aPackDataFULLTAX['FTXshRefType'] = '1';
            $aPackDataFULLTAX['FTXshRefKey'] = 'ORGFULLTAX';
            $aPackDataFULLTAX['FDXshRefDocDate'] = date('Y-m-d H:i:s');
            $this->db->insert('TPSTTaxHDDocRef',$aPackDataFULLTAX);
        }else{
            ...
            /// Insert Current Docref FULLTAX
            $aPackDataFULLTAX['FTBchCode'] = $tBrowseBchCode;
            $aPackDataFULLTAX['FTXshDocNo'] = $tCurretTaxDocNo;
            $aPackDataFULLTAX['FTXshRefDocNo'] = $tTaxNumberFull;
            $aPackDataFULLTAX['FTXshRefType'] = '1';
            $aPackDataFULLTAX['FTXshRefKey'] = 'ABBFULLTAX';
            $aPackDataFULLTAX['FDXshRefDocDate'] = date('Y-m-d H:i:s');
            ...
            $aPackDataFULLTAX['FTBchCode'] = $tBrowseBchCode;
            $aPackDataFULLTAX['FTXshDocNo'] = $tTaxNumberFull;
            $aPackDataFULLTAX['FTXshRefDocNo'] = $tCurretTaxDocNo;
            $aPackDataFULLTAX['FTXshRefType'] = '1';
            $aPackDataFULLTAX['FTXshRefKey'] = 'B4FULLTAX';
            $aPackDataFULLTAX['FDXshRefDocDate'] = date('Y-m-d H:i:s');
            $this->db->insert('TPSTTaxHDDocRef',$aPackDataFULLTAX);
    ...
    // Create By: Napat(Jame) 19/10/2021
    // เพิ่มการดึงข้อมูลอ้างอิงเอกสารแบบมัลติ
    public function FSaMTAXGetHDDocRef($ptData){
        $tDocumentNumber    = $ptData['tDocumentNumber'];
        $tBrowseBchCode     = $ptData['tBrowseBchCode'];
        $tSQL   = " SELECT 
                        FTXshRefDocNo,
                    ...
                    WHERE FTXshDocNo = '$tDocumentNumber' 
                      AND FTBchCode = '$tBrowseBchCode' 
                    ORDER BY FTXshRefType ASC, FDXshRefDocDate ASC ";
        $oQuery = $this->db->query($tSQL);
        if( $oQuery->num_rows() > 0 ){
            $aResult    = array(
                'aItems'       => $oQuery->result_array(),
