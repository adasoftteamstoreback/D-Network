                ...
                <table class="table">
                    <thead>
                        ...
                        <tr style="border-bottom: 1px solid black !important">
                            ...
                            <th nowrap class="text-left     xCNRptColumnHeader"   >อ้างอิงเอกสารภายนอก </th>
                    ...
                    <?php if(isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])): ?>
                        ...
                        <?php foreach ($aDataReport['aRptData'] as $nKey=>$aValue): ?>
                            ...
                            <tr>
                                ...
                                <td nowrap class="text-left   xCNRptDetail">  <?php echo $aValue['FTXshRefEXDocNo'];?>              </td>
                                <td nowrap class="text-center xCNRptDetail">  <?php echo trim(substr($aValue['FDXshDocTime'],11,-4));?>             </td>
