        ...
        <div class="xCNContentReport">
            <div id="odvRptTableRPD" class="table-responsive">
                <table class="table" >
                    <thead>
                        <tr>
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptLockerReceiveUserReceive']; ?></th>
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptLockerReceiveBch']; ?></th>
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptLockerReceiveDateTime']; ?></th>
                            <th class="text-left xCNRptColumnHeader" width="10%"><?php echo $aDataTextRef['tRptLockerReceiveRefSal']; ?></th>
                            <th class="text-left xCNRptColumnHeader" width="10%"><?php echo $aDataTextRef['tRptLockerReceiveRefDoc']; ?></th>
                            <th class="text-left xCNRptColumnHeader" width="10%">เลขที่อ้างอิงเอกสารภายนอก</th>
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptLockerReceivePdtCode']; ?></th>
                            <th class="text-left xCNRptColumnHeader" width="15%"><?php echo $aDataTextRef['tRptLockerReceivePdtName']; ?></th>
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptLockerReceivePdtBarCode']; ?></th>
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptLockerReceivePun']; ?></th>
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptLockerReceiveQty']; ?></th>
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptLockerReceiveLayName']; ?></th>
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptLockerReceiveLayNo']; ?></th>
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptLockerReceiveReason']; ?></th>
                        </tr>
                        
                    </thead>
                    <tbody>
                    <?php if(!empty($aDataReport['aRptData'])){ $tCstName = "";?>
                            <?php foreach($aDataReport['aRptData'] as $aData){  ?>
                                <?php 
                                    // $tStyleBorder = '';
                                    // $tCstName = '';
                                    // if ($aData['COUNTBYCST'] == $aData['PARTITIONBYCST']) {
                                    //     $tStyleBorder = 'border-bottom: 1px solid black !important;';
                                    // }else{
                                    //     $tStyleBorder = '';
                                    // } 
                                    
                                    // if ($aData['PARTITIONBYCST'] == 1) {
                                    //     $tCstName = $aData['FTCstName'];
                                    // }else{
                                    //     $tCstName = '';
                                    // }
                                    if($tCstName != $aData['FTCstName']) {
                                        $tCstName = $aData['FTCstName'];
                                ?>
                                <tr style="border-top: solid 1px #333 !important;">                 
                                <td class="xCNRptDetail text-left"><?php echo $aData['FTCstName']?></td>
                                <?php }else{ ?>
                                <td class="xCNRptDetail text-left"> </td>
                                <?php } ?>
                                    <td class="text-left xCNRptDetail"><?=$aData['FTBchName']?></td>
                                    <td class="text-left xCNRptDetail"><?=date('Y-m-d',strtotime($aData['FDXshDatePick']));?> <?=date('H:i:s',strtotime($aData['FDXshDatePick']));?></td>
                                    <td class="text-left xCNRptDetail"><?=$aData['FTXshDocNo']?></td>
                                    <td class="text-left xCNRptDetail"><?=$aData['FTXshRefDocNo']?></td>
                                    <td class="text-left xCNRptDetail"><?=$aData['FTXshRefEXDocNo']?></td>
                                    ...
                                    <td class="text-left xCNRptDetail"><?=(!empty($aData['FTLayName'])?$aData['FTLayName']:'Virtual')?></td>
                                    <td class="text-left xCNRptDetail"><?=$aData['FTRsnName']?></td>
                                </tr>
                            <?php } ?>
                        <?php }else{ ?>
                            <tr>
