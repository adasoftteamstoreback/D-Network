<?php
    ...
    if($aDataFilter['tDocumentType'] == '1'){
        $aDataFilter['tDocumentType'] = 'ฝาก';
    }elseif($aDataFilter['tDocumentType'] == '2'){
        $aDataFilter['tDocumentType'] = 'รับ';
    }else{
        $aDataFilter['tDocumentType'] = 'ทั้งหมด';
    }
    // print_r($aDataFilter['tDocumentType']);
?>
<style>
    /** Set Media Print */
    ...
    <div class="container-fluid xCNLayOutRptHtml">
        ...
        <div class="xCNContentReport">
                ...
                <table class="table">
                    <thead>
                        ...
                        <tr style="border-bottom: 1px solid black !important">
                            <th></th>
                            <th nowrap class="text-left     xCNRptColumnHeader"   >เอกสารอ้างอิงภายนอก</th>
                    ...
                    <?php if(isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])): ?>
                        ...
                        <?php foreach ($aDataReport['aRptData'] as $nKey=>$aValue): ?>
                            ...
                            <?php 
                                ...
                                $aGrouppingDataShp    = array($tShpName,'PID : ('.$tPosCode.') '.$aValue["FTPosName"],'','','','','','','');
                                ...
                                if($aValue["FNRowPartID"] == 1){
                                    ...
                                    for($i = 0;$i<FCNnHSizeOf($aGrouppingDataShp);$i++){
                                        if($aGrouppingDataShp[$i] == $aGrouppingDataShp[0]){
                                            echo "<td class='xCNRptGrouPing' style='padding: 5px;text-indent:15%;' colspan='2'>".$aGrouppingDataShp[$i]."</td>";
                                        }else if($aGrouppingDataShp[$i] == $aGrouppingDataShp[1]){
                                            echo "<td class='xCNRptGrouPing' style='padding: 5px;' colspan='4'>".$aGrouppingDataShp[$i]."</td>";
                                        }else{
                                ...
                                if($aValue['FNXsdLayNo'] == '0'){
                                    $aValue['FNXsdLayNo'] = 'Virtual';
                                }
                                if($aValue['FTSizName'] == ''){
                                    $aValue['FTSizName'] = '-';
                                }
                            ...
                            <tr>
                                ...
                                <td nowrap class="text-left   xCNRptDetail"><?=$aValue['FTXshRefEXDocNo'];?></td>
            ...
            <?php if($nPageNo == $nTotalPage): ?>
                ...
                <!-- ============================ ฟิวเตอร์ข้อมูล เครื่องจุดขาย ============================ -->
                <?php if((isset($aDataFilter['tDocumentType'])  && !empty($aDataFilter['tDocumentType']))): ?>
                    <div class="xCNRptFilterBox">
                        <div class="xCNRptFilter">
                            <label class="xCNRptDisplayBlock"><span class="xCNRptFilterHead"><?php echo 'ประเภทเอกสาร'; ?> : </span> <?php echo $aDataFilter['tDocumentType']; ?></label>
                        </div>
                    </div>
                <?php endif; ?>
