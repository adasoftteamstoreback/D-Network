        ...
        <div class="xCNContentReport">
            <div id="odvTableKoolReport" class="table-responsive">
                <?php if (isset($aDataReport['rtCode']) && !empty($aDataReport['rtCode']) && $aDataReport['rtCode'] == '1') { ?>  
                    <table class="table">
                        <thead>
                        <th nowrap  class="text-left xCNRptColumnHeader" style="width:10%;"><?php echo $aDataTextRef['tRptLockerStatusBranch']; ?></th>   
                        <th nowrap  class="text-left xCNRptColumnHeader" style="width:10%;"><?php echo $aDataTextRef['tRptLockerStatusShop']; ?></th>  
                        <th nowrap  class="text-left xCNRptColumnHeader" style="width:10%;"><?php echo $aDataTextRef['tRptLockerStatusName']; ?></th>    
                        <th nowrap  class="text-left xCNRptColumnHeader" style="width:10%;"><?php echo $aDataTextRef['tRptLockerStatusNumber']; ?></th>
                        <th nowrap  class="text-left xCNRptColumnHeader" style="width:10%;"><?php echo $aDataTextRef['tRptLockerStatusLayName']; ?></th>                        
                        <th nowrap  class="text-left xCNRptColumnHeader" style="width:10%;"><?php echo $aDataTextRef['tRptLockerStatus']; ?></th>   
                        <th nowrap  class="text-left xCNRptColumnHeader" style="width:10%;"><?php echo $aDataTextRef['tRptLockerStatusRefSale']; ?></th>   
                        <th nowrap  class="text-left xCNRptColumnHeader" style="width:10%;">อ้างอิงเอกสาร</th>   
                        <th nowrap  class="text-left xCNRptColumnHeader" style="width:10%;"><?php echo $aDataTextRef['tRptLockerStatusRefDoc']; ?></th>   
                        </thead>
                        
                        <tbody> 
                            <?php 
                                if(!empty($aDataReport['raItems'])){
                                    //เช็ตพารามิตเตอร์
                                    // $tBchCodeAct = "";
                                    $tStyleBch = "";
                                    $tStyleShp = "";
                                    $tShwBch   = "";
                                    // $tShwShp   = "";
                                    foreach($aDataReport['raItems'] as $aData){  
                                        if( $aData['FTBch'] == '1' ){
                                            $tStyleBch = "border-top: solid 1px #333 !important;";
                                            $tShwBch   = $aData['FTBchName'];
                                        }else{
                                            $tStyleBch = "";
                                            $tShwBch   = "";
                                        }
                                        ...
                                        if( $aData['FTShp'] == '1' ){
                                            $tStyleShp = "border-top: dashed 1px #333 !important;";
                                        }else{
                                            $tStyleShp = "";
                                        }

                                        // if( $aData['FTShp'] == '1' ){
                                        //     $tShwShp   = $aData['FTShpName'];
                                        // }else{
                                        //     $tShwShp   = "";
                                        // }
                            ?>
                            <tr style="<?=$tStyleBch?>">
                                <td class="xCNRptDetail text-left"><?=$tShwBch?></td>
                                <td class="xCNRptDetail text-left" style="<?=$tStyleShp?>"><?=$aData['FTShpName']?></td>
                                <td class="text-left xCNRptDetail" style="<?=$tStyleShp?>"><?php echo $aData['FTPosName']?></td>
                                <td class="text-left xCNRptDetail" style="<?=$tStyleShp?>"><?php echo $aData['FNLayNo']?></td>
                                <td class="text-left xCNRptDetail" style="<?=$tStyleShp?>"><?php echo $aData['FTLayName']?></td>
                                <td class="text-left xCNRptDetail" style="<?=$tStyleShp?>"><?php echo $aData['FTLayStaUse']?></td>
                                <td class="text-left xCNRptDetail" style="<?=$tStyleShp?>"><?php echo $aData['FTLksRefSale']?></td>
                                <td class="text-left xCNRptDetail" style="<?=$tStyleShp?>"><?php echo $aData['FTLksRefCstDoc']?></td>                          
                                <td class="text-left xCNRptDetail" style="<?=$tStyleShp?>"><?php echo $aData['FTXshRefEXDocNo']?></td>                          
                            </tr>
                        <?php } ?>
                        <?php }else{?>
                            <tr>
                                <td colspan="18" class="text-center xCNRptColumnFooter"><?php echo $aDataTextRef['tRptLockerStatusNoData']; ?></td>
                            </tr>  
                        <?php }?>
                    </tbody>
                    </table>
            ...
            <?php if($aDataReport['rtCode'] == '800' || $nCurrentPage == $nAllPage): ?>
                ...
                <?php if (isset($aDataFilter['tBchCodeFrom']) && !empty($aDataFilter['tBchCodeFrom'])) : ?>
                    <div class="xCNRptFilterBox">
                        <div class="xCNRptFilter">
                            <label class="xCNRptDisplayBlock"><span class="xCNRptFilterHead"><?php echo $aDataTextRef['tRPCBchFrom']; ?> : </span> <?php echo ($aDataFilter['tBchNameFrom']) ?></label>
                        </div>
                    </div>
                <?php endif; ?>
                <?php if ((isset($aDataFilter['tShpCodeFrom']) && !empty($aDataFilter['tShpCodeFrom'])) && (isset($aDataFilter['tShpNameFrom']) && !empty($aDataFilter['tShpNameFrom']))): ?>
                    <!-- ============================ ฟิวเตอร์ข้อมูล ร้านค้า ============================ -->
                    <div class="xCNRptFilterBox">
                        <div class="xCNRptFilter">
                            ...
                            <label class="xCNRptDisplayBlock"><span class="xCNRptFilterHead"><?php echo $aDataTextRef['tRptShopTo']; ?> : </span> <?php echo $aDataFilter['tShpNameFrom']; ?></label>
                        </div>
                    </div>
                <?php endif; ?>
