                 ...
                 <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th nowrap class="text-left  xCNRptColumnHeader"  style="width:20%;vertical-align:middle;border-bottom: 1px solid black !important" rowspan="2"><?php echo $aDataTextRef['tRptDepositPosID'];?></th>
                        ...
                        <?php if(isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])): ?>
                            ...
                            <?php foreach($aDataReport['aRptData'] as $nKey=>$aValue) : ?>
                                <?php
                                    ...
                                    $nBillQTY_SumSHP  = number_format($aValue['FNXshQTYBill_SUMPOS'],$nOptDecimalShow);
                                ...
                                <?php
                                    ...
                                    $aGrouppingDataBch  = array('('.$tBchCode. ') '.$tBchName,'',$nBillQTY_SumBch);
                                    $aGrouppingDataShp  = array($tShpName,'PID : ('.$tPosCode.') '.$tPosName,$nBillQTY_SumSHP);
                                ...
                                <?php  $aFooterSumData = array($aDataTextRef['tRptDepositTimeAll'], $nBillQTY_Footer);?> 
                            <?php endforeach; ?>
