...
<style>
    ...
    .table>thead:first-child>tr:first-child>td:nth-child(7),
    .table>thead:first-child>tr:first-child>th:nth-child(7),
    .table>thead:first-child>tr:first-child>td:nth-child(8),
    .table>thead:first-child>tr:first-child>th:nth-child(8),
    .table>thead:first-child>tr:first-child>td:nth-child(9),
                ...
                <table class="table" >
                    <thead>
                        <tr>
                            ...
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptRPDSaleDate']; ?></th>
                            <th class="text-right xCNRptColumnHeader"><?php echo $aDataTextRef['tRptRndVal']; ?></th>
                            <th class="text-right xCNRptColumnHeader"><?php echo $aDataTextRef['tRptProductValue']; ?></th>
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptRPDRmkReturn']; ?></th>
                            <th></th>
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptRPDUsrReturn']; ?></th>
                        ...
                        <tr>
                            ...
                            <th class="text-left xCNRptColumnHeader"><?php echo $aDataTextRef['tRptRPDCode']; ?></th>
                        ...
                        <?php if(!empty($aDataReport['aRptData'])){ ?>
                            <?php foreach($aDataReport['aRptData'] as $aData){ ?>
                                <?php
                                    ...
                                    $tSalDate = date("d/m/Y",strtotime($aData['FDXihSalDate']));
                                ...
                                <?php
                                    if($nRowPartID == 0 && $aData["FTXthTnsType"] == "1") { // Grouping Data
                                        // $aGrouppingData = array($tXihDocNo,$tRefIn,$tDocDate,$tSalDate,"N","N", $cXshRnd, $cXtdAmount, $tRsnName, $tUsrName, $tXshApvName);
                                        $aGrouppingData = array($tXihDocNo,$tRefIn,$tDocDate,$tSalDate, $cXshRnd, $cXtdAmount, $tRsnName,$tUsrName);
                                        ...
                                        for($i = 0;$i < FCNnHSizeOf($aGrouppingData); $i++) {
                                            if(strval($aGrouppingData[$i]) != "N") {
                                                switch($i){
                                                    ...
                                                    case 6 : {
                                                        echo "<td colspan='2' class='xCNRptGrouPing  text-left' style='padding: 5px;'>" . $aGrouppingData[$i] . "</td>";
                                                        break;
                                                    }
                                                    default : {
                                                        echo "<td class='xCNRptGrouPing  text-left' style='padding: 5px;'>" . $aGrouppingData[$i] . "</td>";
                                ...
                                <?php if($aData['FNRowPartID'] > 0 && $aData["FTXthTnsType"] == "2"){ // Detail Data ?>
                                    <tr>
                                        ...
                                        <td colspan="5" class="text-left xCNRptDetail"><?php echo $aData['FTPdtName']; ?></>
                                        ...
                                        <td class="text-right xCNRptDetail"><?php echo number_format($aData['FCXtdAmount'], $nOptDecimalShow); ?></td> -->
                                    </tr>
                                <?php } ?>

                                <?php
                                    $paFooterSumData = array($aDataTextRef['tRptRPDTotalReturnValue'], 'N','N', 'N', 
