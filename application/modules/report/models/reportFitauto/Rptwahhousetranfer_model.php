...
class Rptwahhousetranfer_model extends CI_Model
{
    //Call Stored
    public function FSnMExecStoreReport($paDataFilter)
    {
        ...
        $tCallStore = "{ CALL SP_RPTxPdtWahTransfer(?,?,?,?,?,?,?,?,?,?,?,?,?,?) }";
        $aDataStore = array(
    ...
    public function FSaMGetDataReport($paDataWhere)
    {
        ...
        if ($nPage == $nTotalPage) {
            $tJoinFoooter = "   
                ...
                FROM TRPTPdtWahTransferTmp WITH(NOLOCK)
                WHERE 1=1
        ...
        $tSQL = "
            ...
            FROM (
                SELECT
                    ...
                    A.*
                FROM TRPTPdtWahTransferTmp A WITH(NOLOCK)
    ...
    private function FMaMRPTPagination($paDataWhere)
    {
        ...
        $tSQL = "SELECT
                 ...
                 FROM TRPTPdtWahTransferTmp RPT WITH(NOLOCK)
