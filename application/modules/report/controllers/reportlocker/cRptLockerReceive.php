...
class cRptLockerReceive extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportlocker/mRptLockerReceive');
    ...
    private function init()
    {
        $this->aText = [
            ...
            // TitleReport
            'tTitleReport' => language('report/report/report', 'tRptLockerReceiveTitle'),
            ...
            // Table Label
            'tRptLockerReceiveTitle' => language('report/report/report', 'tRptLockerReceiveTitle'),
            'tRptLockerReceiveUserReceive' => language('report/report/report', 'tRptLockerReceiveUserReceive'),
            'tRptLockerReceiveBch' => language('report/report/report', 'tRptLockerReceiveBch'),
            'tRptLockerReceiveDateTime' => language('report/report/report', 'tRptLockerReceiveDateTime'),
            'tRptLockerReceiveRefSal' => language('report/report/report', 'tRptLockerReceiveRefSal'),
            'tRptLockerReceiveRefDoc' => language('report/report/report', 'tRptLockerReceiveRefDoc'),
            'tRptLockerReceivePdtCode' => language('report/report/report', 'tRptLockerReceivePdtCode'),
            'tRptLockerReceivePdtName' => language('report/report/report', 'tRptLockerReceivePdtName'),
            'tRptLockerReceivePdtBarCode' => language('report/report/report', 'tRptLockerReceivePdtBarCode'),
            'tRptLockerReceivePun' => language('report/report/report', 'tRptLockerReceivePun'),
            'tRptLockerReceiveQty' => language('report/report/report', 'tRptLockerReceiveQty'),
            'tRptLockerReceiveLayName' => language('report/report/report', 'tRptLockerReceiveLayName'),
            'tRptLockerReceiveLayNo' => language('report/report/report', 'tRptLockerReceiveLayNo'),
            'tRptLockerReceiveReason' => language('report/report/report', 'tRptLockerReceiveReason'),
            ...
            'tRptLockerPickBch' => language('report/report/report', 'tRptLockerPickBch'),
            'tRptLockerPickDate' => language('report/report/report', 'tRptLockerPickDate'),
            'tRptLockerPickRefSal' => language('report/report/report', 'tRptLockerPickRefSal'),
            'tRptLockerPickRefDoc' => language('report/report/report', 'tRptLockerPickRefDoc'),
            'tRptLockerPickPdtCode' => language('report/report/report', 'tRptLockerPickPdtCode'),
            'tRptLockerPickPdtName' => language('report/report/report', 'tRptLockerPickPdtName'),
            'tRptLockerPickPdtBarCode' => language('report/report/report', 'tRptLockerPickPdtBarCode'),
            'tRptLockerPickPdtPun' => language('report/report/report', 'tRptLockerPickPdtPun'),
            'tRptLockerPickPdyQ' => language('report/report/report', 'tRptLockerPickPdyQ'),
            'tRptLockerPickLayName' => language('report/report/report', 'tRptLockerPickLayName'),
            'tRptLockerPickLayNo' => language('report/report/report', 'tRptLockerPickLayNo'),
            'tRptLockerPickUser' => language('report/report/report', 'tRptLockerPickUser'),
            'tRptLockerPickReason' => language('report/report/report', 'tRptLockerPickReason'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptLockerReceive->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport = $this->mRptLockerReceive->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportlocker/reportLockerReceive', 'wRptLockerReceiveHtml', $aDataViewRpt);
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->mRptLockerReceive->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            WriterEntityFactory::createCell(language('report/report/report', 'tRptLockerReceiveUserReceive')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptLockerReceiveBch')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptLockerReceiveDateTime')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptLockerReceiveRefSal')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptLockerReceiveRefDoc')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptLockerReceivePdtCode')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptLockerReceivePdtName')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptLockerReceivePdtBarCode')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptLockerReceivePun')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptLockerReceiveQty')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptLockerReceiveLayName')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptLockerReceiveLayNo')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptLockerReceiveReason')),
            WriterEntityFactory::createCell(null),
        ];
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                $values = [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(date('Y-m-d',strtotime($aValue['FDXshDatePick'])). ' ' .date('H:i:s',strtotime($aValue['FDXshDatePick']))),
                    WriterEntityFactory::createCell(null),
