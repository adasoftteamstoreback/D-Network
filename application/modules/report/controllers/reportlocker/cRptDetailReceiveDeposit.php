...
class cRptDetailReceiveDeposit extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportlocker/mRptDetailReceiveDeposit');
    ...
    private function init() {
        ...
        $this->aText = [
            ...
            // Title Report
            'tTitleReport'          => language('report/report/report', 'tRptDetailReceiveDeposit'),
            ...
            'tRptXshDocNo'          => language('common/main/main', 'tRptXshDocNo'),
            'tRptDNPDepositDate'    => language('common/main/main', 'tRptDNPDepositDate'),
            'tRptTime'              => language('common/main/main', 'tRptTime'),
            'tRptDNPChannel'        => language('common/main/main', 'tRptDNPChannel'),
            'tRptSize'              => language('common/main/main', 'tRptSize'),
            'tRptBookingLockerRate' => language('common/main/main', 'tRptBookingLockerRate'),
            'tRptDNPDepositor'      => language('common/main/main', 'tRptDNPDepositor'),
            'tRptDNPTrackingNumber' => language('common/main/main', 'tRptDNPTrackingNumber'),
            'tRptDNPRecipient'      => language('common/main/main', 'tRptDNPRecipient'),
            'tRptLockerPickByDatePickDate' => language('common/main/main', 'tRptLockerPickByDatePickDate'),
            'tRptStaPickUp'         => language('common/main/main', 'tRptStaPickUp'),

            'tRptLockerPosIDFrom'   => language('common/main/main', 'tRptLockerPosIDFrom'),
            'tRptLockerPosIDTo'     => language('common/main/main', 'tRptLockerPosIDTo'),
        ...
        $this->aRptFilter = [
            ...
            'tDocumentType'   => !empty($this->input->post('ocmRptStaDocumentType')) ? $this->input->post('ocmRptStaDocumentType') : "",
    ...
    public function index() {
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
           ...
           $this->mRptDetailReceiveDeposit->FSnMExecStoreCReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataMain) {
        try {
            ...
            /*=====  Get Data ==========================================================*/
            $aDataReport        = $this->mRptDetailReceiveDeposit->FSaMGetDataReport($aDataReportParams);
            /*===== End Get Data =======================================================*/
            /*===== Begin Render View ==================================================*/
            ...
            // Load View Advance Table
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportlocker/rptDetailReceiveDeposit', 'wRptDetailReceiveDepositHtml', $aDataViewRptParams);
    ...
    public function FSoCChkDataReportInTableTemp($paDataMain) {
        ...
        try {
            ...
            $nDataCountPage = $this->mRptDetailReceiveDeposit->FSnMCountRowInTemp($aDataCountData);
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(language('report/report/report', 'tRptshop')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRentAmountPosID')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptXshDocNo')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDNPDepositDate')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptTime')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDNPChannel')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptSize')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptBookingLockerRate')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDNPDepositor')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDNPTrackingNumber')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDNPRecipient')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptLockerPickByDatePickDate')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptTime')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptStaPickUp')),
            WriterEntityFactory::createCell(null),
        ];
        ...
        $aDataReport = $this->mRptDetailReceiveDeposit->FSaMGetDataReport($aDataWhereRpt);
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                if($aValue['FNXsdLayNo']==0 && empty($aValue['FTSizName']) ){
                    $tRateDeposit = '';
                    $tStaPick = '';
                    $tDatePick = '';
                    $tDatePick = '';

                        if(!empty($aValue['FDXshDatePick'])){
                        $tStaPick = 'รับแล้ว';
                        $tDatePick = substr($aValue['FDXshDatePick'],0,-13);  
                        }else{
                        $tStaPick ='ยังไม่รับ';
                        $tDatePick = '';
                        }
                ...
                $values = [
                    ...
                    // WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(substr($aValue['FDXshDocDate'],0,-13)),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXshDocTime']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell('Virtual'),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell('-'),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXshRefExt']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXshFrmLoginName']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXshToLoginName']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($tDatePick),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXshTimePick']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($tStaPick),
                    WriterEntityFactory::createCell(null),
                ];
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell($aValue['FTXshDocTime']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FNXsdLayNo']),
                    WriterEntityFactory::createCell(null),
