...
class cRptReceiveLot extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportlocker/mRptReceiveLot');
    ...
    private function init()
    {
        $this->aText = [
            ...
            // TitleReport
            'tTitleReport' => language('report/report/report', 'tRptReceiveLotTitle'),
            ...
            // Table Label
            'tRptReceiveLot_L' => language('report/report/report', 'tRptReceiveLot_L'),
            'tRptReceiveLotPdtCode' => language('report/report/report', 'tRptReceiveLotPdtCode'),
            'tRptReceiveLotPdtName' => language('report/report/report', 'tRptReceiveLotPdtName'),
            'tRptReceiveLotPdtBarCode' => language('report/report/report', 'tRptReceiveLotPdtBarCode'),
            'tRptReceiveLotPdtQty' => language('report/report/report', 'tRptReceiveLotPdtQty'),
            'tRptReceiveLotPdtPun' => language('report/report/report', 'tRptReceiveLotPdtPun'),
            'tRptReceiveLotBch' => language('report/report/report', 'tRptReceiveLotBch'),
            'tRptReceiveLotWah' => language('report/report/report', 'tRptReceiveLotWah'),
            'tRptReceiveLotRefDoc' => language('report/report/report', 'tRptReceiveLotRefDoc'),
            'tRptReceiveLotDate' => language('report/report/report', 'tRptReceiveLotDate'),
            'tRptReceiveLotDateUser' => language('report/report/report', 'tRptReceiveLotDateUser'),
        ...
        $this->aRptFilter = [
            ...
            'tWahCodeOut' => !empty($this->input->post('oetRptWahCodeFromIn')) ? $this->input->post('oetRptWahCodeFromIn') : "",
            'tWahCodeOutName' => !empty($this->input->post('oetRptWahNameFromIn')) ? $this->input->post('oetRptWahNameFromIn') : "",
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptReceiveLot->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport = $this->mRptReceiveLot->FSaMGetDataReport($aDataWhereRpt);
        // print_r($aDataReport);
        // die();
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportlocker/reportReceiveLot', 'wRptReceiveLotHtml', $aDataViewRpt);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportlocker/rptLockerPick', 'wRptLockerPickHtml', $aDataViewRpt);
        // Data Viewer Center Report
        $aDataViewer = array(
            'tTitleReport' => $this->aText['tTitleReport'],
            'tRptTypeExport' => $this->tRptExportType,
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->mRptReceiveLot->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReceiveLot_L')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReceiveLotPdtCode')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReceiveLotPdtName')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReceiveLotPdtBarCode')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReceiveLotPdtQty')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReceiveLotPdtPun')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReceiveLotBch')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReceiveLotWah')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReceiveLotRefDoc')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReceiveLotDate')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReceiveLotDateUser')),
            WriterEntityFactory::createCell(null),
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    WriterEntityFactory::createCell($aValue['FTPdtBatchID']),
                    WriterEntityFactory::createCell(null),
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FDXthDocDateD']),
                    WriterEntityFactory::createCell(null),
    ...
    public function FSoCCallRptRenderFooterExcel()
    {
        ...
        // ฟิวเตอร์ คลัง
        if ((isset($this->aRptFilter['tWahCodeOut']) && !empty($this->aRptFilter['tWahCodeOut'])) ) {
            $aCells = [
                WriterEntityFactory::createCell($this->aText['tRptAdjWahFrom'] . ' : ' . $this->aRptFilter['tWahCodeOutName']),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
