...
class Rptwahhousetranfer_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptwahhousetranfer_model');
    ...
    {
        $this->aText = [
            'tTitleReport'          => language('report/report/report', 'tRptWahtranfer'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptwahhousetranfer_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        try {
            ...
            $aDataReport = $this->Rptwahhousetranfer_model->FSaMGetDataReport($aDataWhere);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->Rptwahhousetranfer_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase)
    {
        try {
            ...
            $nDataCountPage = $this->Rptwahhousetranfer_model->FSnMCountDataReportAll($aDataCountData);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aDataReport = $this->Rptwahhousetranfer_model->FSaMGetDataReport($aDataReportParams);
