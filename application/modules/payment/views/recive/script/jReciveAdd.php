<script type="text/javascript">
    ...
    function JSxNextFuncFormatValidate(ptFmtCode) {
        if (ptFmtCode != 'NULL') {
            ...
            $('#oetRcvCouponCode').val("")
            $('#oetRcvCouponName').val("")
        } else {
        ...
        // Check Format Code
        var tFmtCode    = JSON.parse(ptFmtCode);
        $('#oetRcvReadCardCode').val('');
        $('#oetRcvReadCardName').val('');
        if(tFmtCode == '024' || tFmtCode == '013' || tFmtCode == '018' || tFmtCode == '028'){
            $('#odvRcvReadCard').show();
        }else{
            $('#odvRcvReadCard').hide();
        }
    ...
    var oFindCOuponOption      = function(poDataFnc){
        ...
        var oOptionReturn       = {
            ...
            Table   : { Master: 'TFNTCouponHD', PK: 'FTCphDocNo' },
            Join    : {
            ...
            GrideView   : {
                ...
                ColumnsSize             : ['15%', '75%'],
                DataColumns             : ['TFNTCouponHD.FTCphDocNo', 'TFNTCouponHD_L.FTCpnName' ,'TFNMCouponType.FTCptType','TFNTCouponHD.FTCphStaApv'],
                DataColumnsFormat       : ['', ''],
