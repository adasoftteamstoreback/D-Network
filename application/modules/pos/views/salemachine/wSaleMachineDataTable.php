                ...
                <tbody id="odvPOSList">
                    ...
                    if($aPosDataList['rtCode'] == 1 ):?>
                        <?php foreach($aPosDataList['raItems'] AS $nKey => $aValue):?>
                            ...
                            ?>
                            <tr class="text-center xCNTextDetail2 otrSaleMachine" id="otrSaleMachine<?=$nKey?>" data-code="<?=$aValue['rtPosCode'].$aValue['rtBchCode']?>" data-name="<?=$aValue['rtPosRegNo']?>">
                                <td class="text-center">
                                    <label class="fancy-checkbox">
                                        <input id="ocbListItem<?=$nKey;?>" type="checkbox"
                                        <?php echo $tDisabledItem; ?>
                                        data-checkrow="<?php echo $tDisabledcheckrow; ?>"
                                        data-checkrowid="<?php echo $aValue['rtPosCode'].$aValue['rtBchCode']?>" checked="false"
                                        class="ocbListItem" name="ocbListItem[]" >
                                ...
                                <td class="<?=$tDisableTD?>" id="otdDel<?php echo $aValue['rtPosCode'].$aValue['rtBchCode']?>">
                                    <img class="xCNIconTable <?php echo $tClassDisabled ?> <?php echo $tDisableImg; ?>"
                                    id="oimDel<?php echo $aValue['rtPosCode'].$aValue['rtBchCode']; ?>"
