...
/* ขยายฟิวส์จากเดิม */
IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'TCNMPdtCatInfo' AND COLUMN_NAME = 'FTCatParent' AND CHARACTER_MAXIMUM_LENGTH = 10) BEGIN
