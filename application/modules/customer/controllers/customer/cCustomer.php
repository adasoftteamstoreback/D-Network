...
class cCustomer extends MX_Controller {
    ...
    public function FSxCCSTSendDataMemberV5($paParams){
        ...
        // if( defined(MemberV5_HOST) && defined(MemberV5_PORT) && defined(MemberV5_USER) && defined(MemberV5_PASS) && defined(MemberV5_VHOST) ){
        //     if ( MemberV5_HOST !== "undefined" ){
