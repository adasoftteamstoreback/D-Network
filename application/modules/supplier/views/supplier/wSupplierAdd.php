<?php
    ...
    if(isset($nStaAddOrEdit) && $nStaAddOrEdit == 1){
        ...
        $tSqlUsrCode        = $aSplData['raItems']['rtUsrCode'];
...
<style>
    ...
    <input type="hidden" name="ohdSplBusiness" id="ohdSplBusiness" value="<?php echo $tSplBusiness; ?>"/>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="odvInfo1" class="tab-pane fade active in">
                            ...
                            <form class="contact100-form validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data" id="ofmAddsupplier1">
                                        ...
                                        <div style="padding-left: 15px;">
                                            <div class="row">
                                                <div class="col-md-4 col-sm-12">
                                                    <label class="fancy-radio xCNRadioMain" style="padding-left: 0px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" placeholder="<?php echo language('supplier/supplier/supplier','tEmail')?>" maxlength="50" id="oemtSplEmail" value="<?php echo $tSplEmail;?>" name="oemtSplEmail" data-validate-email="<?php echo language('supplier/supplier/supplier','tValidEmail')?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-sm-12" style="border-top: 1px solid #f1f1f1;padding-top: 10px;margin-top: 10px;">
                                        <span style="font-weight: bold;font-size: 20px !important;">ประเภท</span>
                                        <div style="padding-left: 15px;">
                                            <div class="row">
                                                <div class="col-md-4 col-sm-12">
                                                    <label class="fancy-radio xCNRadioMain ">
                                                        <input type="radio" class="xWlBusinessPerson" id="ordSplBusinessPerson" name="ordSplBusiness" value="1" <?php echo ($tSplBusiness == 1 || $nStaAddOrEdit == 99)? 'checked':'';?>>
                                                        <span><i></i> <?php echo language('supplier/supplier/supplier','tPerson')?></span>
                                                    </label>
                                                </div>
                                                <div class="col-md-4 col-sm-12">
                                                    <label class="fancy-radio xCNRadioMain" style="padding-left: 0px;">
                                                        <input type="radio" class="xWlBusinessPerson" id="ordSplBusinessCorporate" name="ordSplBusiness" value="2" <?php echo ($tSplBusiness == 2)? 'checked':'';?>>
                                ...
                                <div class="row xCNHide" id="odvBranch">
                                    <div class="col-md-8 col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="selectpicker form-control xCNSelectBox" id="ocbSplStaBchOrHQ" name="ocbSplStaBchOrHQ">
                                                        <option value="1" <?php echo $tSplStaBchOrHQ == '1' ? 'selected' : '';?> >สำนักงานใหญ่</option>
                                                        <option value="" <?php echo $tSplStaBchOrHQ != '1' ? 'selected' : '';?>>สาขา</option>
                                                    </select>
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-sm-12" style="border-top: 1px solid #f1f1f1;padding-top: 10px;margin-top: 10px;padding-bottom: 10px;">
                                ...
                                <div class="row">
                                    <div class="col-md-8" style="border-bottom: 1px solid #f1f1f1;margin-bottom: 20px;padding-bottom: 5px;padding-left: 30px;padding-right: 30px;">
                                        <div class="form-group">
                                            <label class="xCNLabelFrm"><?php echo language('supplier/supplier/supplier','tVat')?></label>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control xCNHide" id="oetUsrCode" name="oetUsrCode" value="<?=@$tSqlUsrCode?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        //ควบคุม Chk Box สำนักงานใหญ่
        // var nStaHQ = $("#ocbSplStaBchOrHQ").is(':checked');
        // if (nStaHQ == true) {
        //     $("#oetSplBchCode").val('');
        //     $("#oetSplBchCode").attr('readonly', true)
        // } else {
        //     $("#oetSplBchCode").removeAttr('readonly', true)
        // }

        // $('#ocbSplStaBchOrHQ').click(function() {
        //     if ($(this).is(':checked')) {
        //         $("#oetSplBchCode").val('');
        //         $("#oetSplBchCode").attr('readonly', true)
        //     }else{
        ...
        var tStaHQ = $("#ocbSplStaBchOrHQ").val();
        if ( tStaHQ == '1' ) {
            $("#oetSplBchCode").val('');
            $("#oetSplBchCode").attr('readonly', true);
        } else {
        ...
        $('#ocbSplStaBchOrHQ').change(function() {
            if ( $(this).val() == '1' ) {
                $("#oetSplBchCode").val('');
                $("#oetSplBchCode").attr('readonly', true)
            }else{
    ...
    var SplBusiness = $("#ohdSplBusiness").val();
	$('.xWBtnHide').show();
