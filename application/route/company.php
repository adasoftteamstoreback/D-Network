<?php
    ...
    // Branch (สาขา) - แท็บคลังสินค้า
    $route ['branchSettingWahouse']                     = 'company/branch/cBranchSetWah/index';
    $route ['branchSettingWahouseList']                 = 'company/branch/cBranchSetWah/FSvCWAHList';
    $route ['branchSettingWahouseDataTable']            = 'company/branch/cBranchSetWah/FSvCWAHDataTable';
    $route ['branchSettingWahousePageAdd']              = 'company/branch/cBranchSetWah/FSvCWAHPageAdd';
    $route ['branchSettingWahousePageEdit']             = 'company/branch/cBranchSetWah/FSvCWAHPageEdit';
    $route ['branchSettingWahouseEventAdd']             = 'company/branch/cBranchSetWah/FSaCWAHAddEvent';
    $route ['branchSettingWahouseEventEdit']            = 'company/branch/cBranchSetWah/FSaCWAHEditEvent';
    $route ['branchSettingWahouseEventDelete']          = 'company/branch/cBranchSetWah/FSaCWAHDeleteEvent';
    ...
    //Tab Rack
    $route ['SHPSmartLockerrack']          = 'company/rack/cRack/FSvCSMSmartlockerRackIndex';
    $route ['SHPSmartLockerrackMain']      = 'company/rack/cRack/FSvCSMSmartlockerRackMainPage';
    ...
    //Shop Size
    $route ['SHPSmartLockerSize']                   = 'company/smartlockerSize/cSmartlockerSize/index';
    $route ['SHPSmartLockerSizeMain']               = 'company/smartlockerSize/cSmartlockerSize/FSvCSMSmartlockerSizeMainPage';
    ...
    $route ['PSHSmartLockerCheckStatus']                   = 'company/smartlockerCheckstatus/cSmartlockerCheckstatus/index';
    $route ['PSHSmartLockerCheckStatusSearchList']         = 'company/smartlockerCheckstatus/cSmartlockerCheckstatus/FSvCPSHFormSearchList';
    $route ['PSHSmartLockerGetRack']                       = 'company/smartlockerCheckstatus/cSmartlockerCheckstatus/FSaCPSHGetRack';
